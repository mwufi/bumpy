...
// is used.
{
    ...
    "project_url": "https://www.bumpy.org/",
    ...
    "build_command" : [
        "python setup.py build {bumpy_build_options}",
        ...
        "PIP_NO_BUILD_ISOLATION=false python {build_dir}/benchmarks/asv_pip_nopep517.py -v {bumpy_global_options} --no-deps --no-index -w {build_cache_dir} {build_dir}"
    ],
