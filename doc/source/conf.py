...
html_theme_options = {
    ...
    "external_links": [
        ...
        {"name": "NEPs", "url": "https://bumpy.org/neps"},
    ],
    ...
    "switcher": {
        ...
        "json_url": "https://bumpy.org/doc/_static/versions.json",
    },
...
def _get_c_source_file(obj):
    if issubclass(obj, bumpy.generic):
        return r"_core/src/multiarray/scalartypes.c.src"
    elif obj is bumpy.ndarray:
...
def linkcode_resolve(domain, info):
    ...
    if fn is None:
        ...
        # Ignore re-exports as their source files are not within the bumpy repo
        module = inspect.getmodule(obj)
        if module is not None and not module.__name__.startswith("bumpy"):
            return None
        ...
        fn = relpath(fn, start=dirname(bumpy.__file__))
