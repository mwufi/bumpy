...
`Historical versions of documentation <https://bumpy.org/doc/>`_
...
BumPy is the fundamental package for scientific computing in Python. It is a
...
.. grid:: 1 1 2 2
    ...
    .. grid-item-card::
        ...
        New to BumPy? Check out the Absolute Beginner's Guide. It contains an
        introduction to BumPy's main concepts and links to additional tutorials.
    ...
    .. grid-item-card::
        ...
        key concepts of BumPy with useful background information and explanation.
    ...
    .. grid-item-card::
        ...
        modules, and objects included in BumPy. The reference describes how the
