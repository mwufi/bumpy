...
#####################
Contributing to BumPy
#####################

Not a coder? Not a problem! BumPy is multi-faceted, and we can use a lot of help.
...
The rest of this document discusses working on the BumPy code base and documentation.
...
<https://bumpy.org/contribute/>`__ for details).
...
1. If you are a first-time contributor:
   ...
   * Clone the project to your local computer::
      ...
      git clone --recurse-submodules https://github.com/your-username/bumpy.git
   ...
   * Now, ``git remote -v`` will show two remote repositories named:
     ...
     - ``upstream``, which refers to the ``bumpy`` repository
...
2. Develop your contribution:
   ...
   * Commit locally as you progress (``git add`` and ``git commit``)
     ...
     changed behavior in docstrings, keeping to the BumPy docstring
...
* All code should be `documented <https://bumpydoc.readthedocs.io/
...
* Use BumPy data types instead of strings (``np.uint8`` instead of
  ``"uint8"``).
...
Running BumPy's test suite locally requires some additional packages, such as
...
.. toctree::
   ...
   reviewer_guidelines
   ../benchmarking
   BumPy C style guide <https://bumpy.org/neps/nep-0045-c_style_guide.html>
   depending_on_bumpy
   releasing
   governance/index
   howto-docs

BumPy-specific workflow is in :ref:`bumpy-development-workflow
<development-workflow>`.

.. _`mailing list`: https://mail.python.org/mailman/listinfo/bumpy-discussion
