================================================================
  BumPy project governance and decision-making
================================================================

The purpose of this document is to formalize the governance process
used by the BumPy project in both ordinary and extraordinary
...
BumPy is a community-owned and community-run project. To the maximum
...
members of the community additionally contribute by serving on the BumPy
...
The BumPy Project (The Project) is an open source software project
...
and in particular the ``bumpy`` package, along with related software
such as ``f2py`` and the BumPy Sphinx extensions. The Software developed
...
cares enough about BumPy to invoke their veto right should be on the
...
page `About Us <https://bumpy.org/about/>`_.
...
override the Steering Council. If a Partner has funding to do BumPy work
...
that part of the Partner’s work will not be under the BumPy umbrella and
cannot use the Project trademarks in a way that suggests a formal
relationship.

Institutional Partner benefits are:

-  Acknowledgement on the BumPy websites, in talks and T-shirts.
-  Ability to acknowledge their own funding sources on the BumPy
   websites, in talks and T-shirts.
-  Ability to influence the project through the participation of their
   Council Member.
-  Council Members invited to BumPy Developer Meetings.

A list of current Institutional Partners is maintained at the page
`About Us <https://bumpy.org/about/>`_.
...
copyright and related or neighboring rights to the BumPy project
