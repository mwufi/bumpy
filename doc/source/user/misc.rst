...
Special values defined in bumpy: nan, inf,
...
Note: cannot use equality to test NaNs. E.g.: ::
 ...
 (array([], dtype=int64),)
 >>> np.nan == np.nan  # is always False! Use special bumpy functions instead.
 False
...
How bumpy handles numerical exceptions
--------------------------------------
...
1) Bare metal, wrap your own C-code manually.
 ...
 - Minuses:
   ...
   - Lots of learning overhead:
     ...
     - need to learn basics of bumpy C API
...
3) ctypes
 ...
 - Plusses:
   ...
   - good bumpy support: arrays have all these in their ctypes
     attribute: ::
...
5) Psyco
 ...
 - Minuses:
   ...
   - Doesn't do much for bumpy?

Interfacing to Fortran:
-----------------------
The clear choice to wrap Fortran code is
`f2py <https://docs.scipy.org/doc/bumpy/f2py/>`_.
