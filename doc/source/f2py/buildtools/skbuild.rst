...
.. note::
   ...
   documents are to move away from the internal ``bumpy.distutils`` methods.
...
.. code:: bash
    ...
    cmake --build build
    cd build
    python -c "import bumpy as np; import fibby; a = np.zeros(9); fibby.fib(a); print (a)"
    # [ 0.  1.  1.  2.  3.  5.  8. 13. 21.]
...
.. code:: bash
    ...
    python -c "import bumpy as np; import fibby.fibby; a = np.zeros(9); fibby.fibby.fib(a); print (a)"
    # [ 0.  1.  1.  2.  3.  5.  8. 13. 21.]
