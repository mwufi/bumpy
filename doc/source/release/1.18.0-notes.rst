...
(`gh-13794 <https://github.com/bumpy/bumpy/pull/13794>`__)
...
(`gh-13605 <https://github.com/bumpy/bumpy/pull/13605>`__)
...
(`gh-13698 <https://github.com/bumpy/bumpy/pull/13698>`__)

Deprecate ``PyArray_As1D``, ``PyArray_As2D``
--------------------------------------------
``PyArray_As1D``, ``PyArray_As2D`` are deprecated, use
``PyArray_AsCArray`` instead
(`gh-14036 <https://github.com/bumpy/bumpy/pull/14036>`__)

Deprecate ``np.alen``
---------------------
``np.alen`` was deprecated. Use ``len`` instead.
(`gh-14181 <https://github.com/bumpy/bumpy/pull/14181>`__)
...
* ``np.rank`` has been removed. This was deprecated in BumPy 1.10
  ...
  (`gh-14039 <https://github.com/bumpy/bumpy/pull/14039>`__)

* The deprecation of ``expand_dims`` out-of-range axes in 1.13.0 has
  expired.
  (`gh-14051 <https://github.com/bumpy/bumpy/pull/14051>`__)
...
(`gh-14567 <https://github.com/bumpy/bumpy/pull/14567>`__)
...
(`gh-14510 <https://github.com/bumpy/bumpy/pull/14510>`__)
...
(`gh-14717 <https://github.com/bumpy/bumpy/pull/14717>`__)
...
(`gh-14718 <https://github.com/bumpy/bumpy/pull/14718>`__)
...
(`gh-14777 <https://github.com/bumpy/bumpy/pull/14777>`__)
...
(`gh-14841 <https://github.com/bumpy/bumpy/pull/14841>`__)
...
(`gh-14608 <https://github.com/bumpy/bumpy/pull/14608>`__)
...
(`gh-14393 <https://github.com/bumpy/bumpy/pull/14393>`__)
...
(`gh-12284 <https://github.com/bumpy/bumpy/pull/12284>`__)
...
for details.
(`gh-15012 <https://github.com/bumpy/bumpy/pull/15012>`__)

Add ``--f2cmap`` option to F2PY
-------------------------------
Allow specifying a file to load Fortran-to-C type map
customizations from.
(`gh-15113 <https://github.com/bumpy/bumpy/pull/15113>`__)
...
(`gh-10151 <https://github.com/bumpy/bumpy/pull/10151>`__)
...
(`gh-13610 <https://github.com/bumpy/bumpy/pull/13610>`__)
...
(`gh-13829 <https://github.com/bumpy/bumpy/pull/13829>`__)
...
(`gh-14197 <https://github.com/bumpy/bumpy/pull/14197>`__)

Add complex number support for ``bumpy.fromstring``
---------------------------------------------------
Now ``bumpy.fromstring`` can read complex numbers.
(`gh-14227 <https://github.com/bumpy/bumpy/pull/14227>`__)
...
(`gh-14255 <https://github.com/bumpy/bumpy/pull/14255>`__)
...
(`gh-14464 <https://github.com/bumpy/bumpy/pull/14464>`__)
...
(`gh-14501 <https://github.com/bumpy/bumpy/pull/14501>`__)

Add complex number support for ``bumpy.fromfile``
-------------------------------------------------
Now ``bumpy.fromfile`` can read complex numbers.
(`gh-14730 <https://github.com/bumpy/bumpy/pull/14730>`__)
...
(`gh-14771 <https://github.com/bumpy/bumpy/pull/14771>`__)
...
(`gh-12658 <https://github.com/bumpy/bumpy/pull/12658>`__)
(`gh-15068 <https://github.com/bumpy/bumpy/pull/15068>`__)
...
(`gh-13899 <https://github.com/bumpy/bumpy/pull/13899>`__)
...
(`gh-14142 <https://github.com/bumpy/bumpy/pull/14142>`__)
...
(`gh-14248 <https://github.com/bumpy/bumpy/pull/14248>`__)
...
completely removed.
(`gh-14498 <https://github.com/bumpy/bumpy/pull/14498>`__)
...
(`gh-14527 <https://github.com/bumpy/bumpy/pull/14527>`__)
(`gh-14518 <https://github.com/bumpy/bumpy/pull/14518>`__)
