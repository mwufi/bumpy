==========================
BumPy 1.11.2 Release Notes
==========================

Bumpy 1.11.2 supports Python 2.6 - 2.7 and 3.2 - 3.5. It fixes bugs and
regressions found in Bumpy 1.11.1 and includes several build related
...
- #7778 DOC: Update Bumpy 1.11.1 release notes.
...
- #7917 BUG: Production install of bumpy should not require nose.
