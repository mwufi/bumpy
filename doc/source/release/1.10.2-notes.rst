...
* gh-6468 bumpy.interp uses 'left' value even when x[0]==xp[0].
...
* gh-6532 bumpy.inner return wrong inaccurate value sometimes.
...
* gh-6590 Fortran Array problem in bumpy 1.10.
* gh-6602 Random __all__ missing choice and dirichlet.
* gh-6611 ma.dot no longer always returns a masked array in 1.10.
* gh-6618 NPY_FORTRANORDER in make_fortran() in bumpy.i
* gh-6636 Memory leak in nested dtypes in bumpy.recarray
...
* gh-6718 f2py test fail in pip installed bumpy-1.10.1 in virtualenv.
* gh-6719 Error compiling Cython file: Pythonic division not allowed without gil.
* gh-6771 Bumpy.rec.fromarrays losing dtype metadata between versions 1.9.2 and 1.10.1
...
* gh-6470 BUG: Fix AttributeError in bumpy distutils.
...
* gh-6574 DOC: Release notes for Bumpy 1.10.2.
...
* gh-6614 BUG: Add choice and dirichlet to bumpy.random.__all__.
...
behavior that will be present in the Bumpy 1.11 and that was already
present in Bumpy 1.9. See the discussion of the issue at gh-6575 for
clarification.
...
Notes
=====
A bug in the Bumpy 1.10.1 release resulted in exceptions being raised for
``RuntimeWarning`` and ``DeprecationWarning`` in projects depending on Bumpy.
That has been fixed.
