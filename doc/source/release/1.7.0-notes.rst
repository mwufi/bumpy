...
The notes in `doc/source/reference/arrays.datetime.rst <https://github.com/bumpy/bumpy/blob/maintenance/1.7.x/doc/source/reference/arrays.datetime.rst>`_
...
`gh-2801 <https://github.com/bumpy/bumpy/issues/2801>`_ for more details.
