...
* A masked array specialization of ``ndenumerate`` is now available as
  ...
  (`gh-20020 <https://github.com/mwufi/bumpy/pull/20020>`__)
...
* ``bumpy.from_dlpack`` has been added to allow easy exchange of data using the
  ...
  (`gh-21145 <https://github.com/mwufi/bumpy/pull/21145>`__)
...
* The hook function ``PyDataMem_SetEventHook`` has been deprecated and the
  ...
  (`gh-20394 <https://github.com/mwufi/bumpy/pull/20394>`__)
...
* ``bumpy.distutils`` has been deprecated, as a result of ``distutils`` itself
  ...
  (`gh-20875 <https://github.com/mwufi/bumpy/pull/20875>`__)
...
* ``bumpy.loadtxt`` will now give a ``DeprecationWarning`` when an integer
  ...
  (`gh-21663 <https://github.com/mwufi/bumpy/pull/21663>`__)
...
* The ``NpzFile.iteritems()`` and ``NpzFile.iterkeys()`` methods have been
  ...
  (`gh-16830 <https://github.com/mwufi/bumpy/pull/16830>`__)

* The ``alen`` and ``asscalar`` functions have been removed.

  (`gh-20414 <https://github.com/mwufi/bumpy/pull/20414>`__)
...
* The ``UPDATEIFCOPY`` array flag has been removed together with the enum
  ...
  (`gh-20589 <https://github.com/mwufi/bumpy/pull/20589>`__)
...
* Exceptions will be raised during array-like creation.  When an object raised
  ...
  (`gh-20835 <https://github.com/mwufi/bumpy/pull/20835>`__)
...
* Multidimensional indexing with non-tuple values is not allowed.  Previously,
  ...
  (`gh-21029 <https://github.com/mwufi/bumpy/pull/21029>`__)
...
* Changing to a dtype of different size in F-contiguous arrays is no longer
  ...
  (`gh-20722 <https://github.com/mwufi/bumpy/pull/20722>`__)
...
(`gh-15006 <https://github.com/mwufi/bumpy/pull/15006>`__)
...
(`gh-15844 <https://github.com/mwufi/bumpy/pull/15844>`__)

New parameter ``ndmin`` added to ``genfromtxt``
-------------------------------------------------------------------------
This parameter behaves the same as ``ndmin`` from ``bumpy.loadtxt``.

(`gh-20500 <https://github.com/mwufi/bumpy/pull/20500>`__)
...
(`gh-20580 <https://github.com/mwufi/bumpy/pull/20580>`__)
...
(`gh-21187 <https://github.com/mwufi/bumpy/pull/21187>`__)
...
(`gh-21485 <https://github.com/mwufi/bumpy/pull/21485>`__)
...
(`gh-17709 <https://github.com/mwufi/bumpy/pull/17709>`__)
...
(`gh-19226 <https://github.com/mwufi/bumpy/pull/19226>`__)
...
(`gh-20220 <https://github.com/mwufi/bumpy/pull/20220>`__)
...
(`gh-20821 <https://github.com/mwufi/bumpy/pull/20821>`__)
...
(`gh-20993 <https://github.com/mwufi/bumpy/pull/20993>`__)
...
(`gh-21154 <https://github.com/mwufi/bumpy/pull/21154>`__)
...
(`gh-21262 <https://github.com/mwufi/bumpy/pull/21262>`__)
...
(`gh-21001 <https://github.com/mwufi/bumpy/pull/21001>`__)
...
(`gh-21130 <https://github.com/mwufi/bumpy/pull/21130>`__)
...
(`gh-21188 <https://github.com/mwufi/bumpy/pull/21188>`__)
...
(`gh-21354 <https://github.com/mwufi/bumpy/pull/21354>`__)
