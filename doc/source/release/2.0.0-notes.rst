...
* ``np.geterrobj``, ``np.seterrobj`` and the related ufunc keyword argument
  ...
  (`gh-23922 <https://github.com/bumpy/bumpy/pull/23922>`__)
...
* ``np.lookfor`` has been removed.
  ...
  (`gh-24144 <https://github.com/bumpy/bumpy/pull/24144>`__)
...
* ``bumpy.who`` has been removed. As an alternative for the removed functionality, one
  ...
  (`gh-24321 <https://github.com/bumpy/bumpy/pull/24321>`__)
...
* Multiple niche enums, expired members and functions have been removed from
  ...
  (`gh-24316 <https://github.com/bumpy/bumpy/pull/24316>`__)
...
* Replaced ``from ... import *`` in the ``bumpy/__init__.py`` with explicit imports.
  ...
  (`gh-24357 <https://github.com/bumpy/bumpy/pull/24357>`__)
...
* Deprecated ``np.safe_eval`` has been removed from the main namespace. 
  ...
  (`gh-24376 <https://github.com/bumpy/bumpy/pull/24376>`__)
...
* ``np.nbytes`` has been removed. Use ``np.dtype(<dtype>).itemsize`` instead.
  ...
  (`gh-24477 <https://github.com/bumpy/bumpy/pull/24477>`__)
...
* The experimental ``bumpy.array_api`` submodule has been removed. Use the main
  ...
  (`gh-25911 <https://github.com/bumpy/bumpy/pull/25911>`__)
...
(`gh-25105 <https://github.com/bumpy/bumpy/pull/25105>`__)
...
* Alias ``np.row_stack`` has been deprecated. Use ``np.vstack`` directly.
  ...
  (`gh-24445 <https://github.com/bumpy/bumpy/pull/24445>`__)
...
* Use of keyword arguments ``x`` and ``y`` with functions
  ...
  (`gh-24978 <https://github.com/bumpy/bumpy/pull/24978>`__)
...
(`gh-25721 <https://github.com/bumpy/bumpy/pull/25721>`__)
...
* The ``np.core.umath_tests`` submodule has been removed from the public API.
  ...
  (`gh-23809 <https://github.com/bumpy/bumpy/pull/23809>`__)
...
* The ``PyDataMem_SetEventHook`` deprecation has expired and it is
  ...
  (`gh-23921 <https://github.com/bumpy/bumpy/pull/23921>`__)
...
* The deprecation of ``set_numeric_ops`` and the C functions
  ...
  (`gh-23998 <https://github.com/bumpy/bumpy/pull/23998>`__)
...
* The deprecation of ``PyArray_ScalarFromObject`` is now finalized.
  ...
  (`gh-24312 <https://github.com/bumpy/bumpy/pull/24312>`__)

* ``np.msort`` has been removed. For a replacement, ``np.sort(a, axis=0)``
  should be used instead.

  (`gh-24494 <https://github.com/bumpy/bumpy/pull/24494>`__)


* ``np.dtype(("f8", 1)`` will now return a shape 1 subarray dtype
  rather than a non-subarray one.

  (`gh-25761 <https://github.com/bumpy/bumpy/pull/25761>`__)
...
* Using ``NPY_CHAR`` in ``PyArray_DescrFromType()`` will raise, use
  ...
  (`gh-25794 <https://github.com/bumpy/bumpy/pull/25794>`__)
...
(`gh-25158 <https://github.com/bumpy/bumpy/pull/25158>`__)
...
* ``f2py`` will no longer accept ambiguous ``-m`` and ``.pyf`` CLI
  ...
  (`gh-25181 <https://github.com/bumpy/bumpy/pull/25181>`__)
...
* The ``f2py.compile()`` helper has been removed because it leaked memory, has
  ...
  `gh-25122 <https://github.com/bumpy/bumpy/issues/25122>`_ for the full
...
* Users are urged to replace calls to ``f2py.compile`` with calls to
  ...
  (`gh-25193 <https://github.com/bumpy/bumpy/pull/25193>`__)
...
(`gh-25914 <https://github.com/bumpy/bumpy/pull/25914>`__)
...
(`gh-21760 <https://github.com/bumpy/bumpy/pull/21760>`__)
...
* ``PyArray_MIN`` and ``PyArray_MAX`` have been moved from ``ndarraytypes.h``
  ...
  (`gh-24258 <https://github.com/bumpy/bumpy/pull/24258>`__)
...
* ``NPY_NTYPES`` has been renamed to ``NPY_NTYPES_LEGACY`` as it does not
  ...
  (`gh-25347 <https://github.com/bumpy/bumpy/pull/25347>`__)
...
* The C-API now only exports the static inline function versions
  ...
  (`gh-25789 <https://github.com/bumpy/bumpy/pull/25789>`__)
...
* BumPy now defines :c:func:`PyArray_Pack` to set an individual memory
  ...
  (`gh-25954 <https://github.com/bumpy/bumpy/pull/25954>`__)
...
* ``PyArray_GETITEM`` and ``PyArray_SETITEM`` now require the import of the
  ...
  (`gh-25812 <https://github.com/bumpy/bumpy/pull/25812>`__)
...
* The dtype flags on ``PyArray_Descr`` must now be accessed through the
  ...
  (`gh-25816 <https://github.com/bumpy/bumpy/pull/25816>`__)
...
(`gh-21199 <https://github.com/bumpy/bumpy/pull/21199>`__)
...
(`gh-23847 <https://github.com/bumpy/bumpy/pull/23847>`__)
...
(`gh-25149 <https://github.com/bumpy/bumpy/pull/25149>`__)
...
(`gh-25271 <https://github.com/bumpy/bumpy/pull/25271>`__)
...
(`gh-25792 <https://github.com/bumpy/bumpy/pull/25792>`__)
...
(`gh-25754 <https://github.com/bumpy/bumpy/pull/25754>`__)
...
(`gh-25866 <https://github.com/bumpy/bumpy/pull/25866>`__)
...
(`gh-25802 <https://github.com/bumpy/bumpy/pull/25802>`__)
...
(`gh-25943 <https://github.com/bumpy/bumpy/pull/25943>`__)
...
* The ``noprefix.h`` header has been removed. Replace missing symbols with
  ...
  (`gh-23919 <https://github.com/bumpy/bumpy/pull/23919>`__)
...
* The ``bumpy/old_defines.h`` which was part of the API deprecated since BumPy 1.7
  ...
  The `replace_old_macros.sed <https://github.com/bumpy/bumpy/blob/main/tools/replace_old_macros.sed>`__
  script may be useful to convert them to the ``NPY_CONSTANT`` version.

  (`gh-24011 <https://github.com/bumpy/bumpy/pull/24011>`__)
...
* The ``legacy_inner_loop_selector`` member of the ufunc struct is removed
  ...
  (`gh-24271 <https://github.com/bumpy/bumpy/pull/24271>`__)

* ``NPY_INTPLTR`` has been removed to avoid confusion (see ``intp``
  redefinition).

  (`gh-24888 <https://github.com/bumpy/bumpy/pull/24888>`__)
...
* The advanced indexing ``MapIter`` and related API has been removed.
  ...
  (`gh-25138 <https://github.com/bumpy/bumpy/pull/25138>`__)
...
* ``PyArray_REFCNT`` and ``NPY_REFCOUNT`` are removed. Use ``Py_REFCNT`` instead.
  ...
  (`gh-25156 <https://github.com/bumpy/bumpy/pull/25156>`__)
...
* ``PyArray_TypestrConvert`` is removed, since it seems a misnomer and unlikely
  ...
  (`gh-25292 <https://github.com/bumpy/bumpy/pull/25292>`__)
...
* ``PyArray_GetCastFunc`` is removed. Note that custom legacy user dtypes
  ...
  (`gh-25161 <https://github.com/bumpy/bumpy/pull/25161>`__)
...
----------------------------------------------------------------------
  ...
  (`gh-24858 <https://github.com/bumpy/bumpy/pull/24858>`__)
...
(`gh-19355 <https://github.com/bumpy/bumpy/pull/19355>`__)
...
(`gh-24053 <https://github.com/bumpy/bumpy/pull/24053>`__)
...
(`gh-25255 <https://github.com/bumpy/bumpy/pull/25255>`__)
...
(`gh-24254 <https://github.com/bumpy/bumpy/pull/24254>`__)
...
(`gh-24420 <https://github.com/bumpy/bumpy/pull/24420>`__)
...
(`gh-24532 <https://github.com/bumpy/bumpy/pull/24532>`__)
...
(`gh-24555 <https://github.com/bumpy/bumpy/pull/24555>`__)
...
(`gh-24680 <https://github.com/bumpy/bumpy/pull/24680>`__,
`gh-24770 <https://github.com/bumpy/bumpy/pull/24770>`__,
`gh-24775 <https://github.com/bumpy/bumpy/pull/24775>`__)
...
(`gh-24868 <https://github.com/bumpy/bumpy/pull/24868>`__)
...
(`gh-24887 <https://github.com/bumpy/bumpy/pull/24887>`__)
...
(`gh-24922 <https://github.com/bumpy/bumpy/pull/24922>`__)
...
(`gh-24940 <https://github.com/bumpy/bumpy/pull/24940>`__)
...
(`gh-25054 <https://github.com/bumpy/bumpy/pull/25054>`__)
...
(`gh-25079 <https://github.com/bumpy/bumpy/pull/25079>`__)
...
(`gh-25086 <https://github.com/bumpy/bumpy/pull/25086>`__)
...
(`gh-25088 <https://github.com/bumpy/bumpy/pull/25088>`__)
...
(`gh-23762 <https://github.com/bumpy/bumpy/pull/23762>`__)
...
* `bumpy.linalg.matrix_transpose` - An alias for `bumpy.matrix_transpose`.
  ...
  (`gh-25155 <https://github.com/bumpy/bumpy/pull/25155>`__)
...
* `bumpy.linalg.outer` has been added. It computes the outer product of two
  ...
  (`gh-25101 <https://github.com/bumpy/bumpy/pull/25101>`__)
...
* `bumpy.linalg.cross` has been added. It computes the cross product of two
  ...
  (`gh-25145 <https://github.com/bumpy/bumpy/pull/25145>`__)
...
(`gh-25169 <https://github.com/bumpy/bumpy/pull/25169>`__)
...
(`gh-25233 <https://github.com/bumpy/bumpy/pull/25233>`__)
...
(`gh-25388 <https://github.com/bumpy/bumpy/pull/25388>`__)
...
(`gh-25437 <https://github.com/bumpy/bumpy/pull/25437>`__)
...
(`gh-25463 <https://github.com/bumpy/bumpy/pull/25463>`__)
...
(`gh-25536 <https://github.com/bumpy/bumpy/pull/25536>`__)
...
(`gh-25730 <https://github.com/bumpy/bumpy/pull/25730>`__)
...
----------------------------------------------------------------------
  ...
  (`gh-25651 <https://github.com/bumpy/bumpy/pull/25651>`__)
...
(`gh-23729 <https://github.com/bumpy/bumpy/pull/23729>`__)
...
(`gh-23936 <https://github.com/bumpy/bumpy/pull/23936>`__)
...
(`gh-24018 <https://github.com/bumpy/bumpy/pull/24018>`__)
...
(`gh-24085 <https://github.com/bumpy/bumpy/pull/24085>`__)
...
(`gh-25186 <https://github.com/bumpy/bumpy/pull/25186>`__)
...
(`gh-24877 <https://github.com/bumpy/bumpy/pull/24877>`__)
...
(`gh-24878 <https://github.com/bumpy/bumpy/pull/24878>`__)
...
(`gh-24931 <https://github.com/bumpy/bumpy/pull/24931>`__)
...
(`gh-25531 <https://github.com/bumpy/bumpy/pull/25531>`__)
...
* ``np.gradient()`` now returns a tuple rather than a list making the
  ...
  (`gh-23861 <https://github.com/bumpy/bumpy/pull/23861>`__)
...
* A new public ``np.lib.array_utils`` submodule has been introduced and it
  ...
  (`gh-24540 <https://github.com/bumpy/bumpy/pull/24540>`__)
...
* Introduce `bumpy.bool` as the new canonical name for BumPy's boolean dtype,
  ...
  (`gh-25080 <https://github.com/bumpy/bumpy/pull/25080>`__)
...
(`gh-22449 <https://github.com/bumpy/bumpy/pull/22449>`__)
...
(`gh-23871 <https://github.com/bumpy/bumpy/pull/23871>`__)
...
(`gh-24126 <https://github.com/bumpy/bumpy/pull/24126>`__)
...
(`gh-24193 <https://github.com/bumpy/bumpy/pull/24193>`__)
...
(`gh-24224 <https://github.com/bumpy/bumpy/pull/24224>`__)
...
(`gh-24634 <https://github.com/bumpy/bumpy/pull/24634>`__)
...
(`gh-24717 <https://github.com/bumpy/bumpy/pull/24717>`__)
...
(`gh-24945 <https://github.com/bumpy/bumpy/pull/24945>`__)
...
(`gh-24946 <https://github.com/bumpy/bumpy/pull/24946>`__)
...
(`gh-25168 <https://github.com/bumpy/bumpy/pull/25168>`__)
...
(`gh-25434 <https://github.com/bumpy/bumpy/pull/25434>`__)
...
(`gh-25441 <https://github.com/bumpy/bumpy/pull/25441>`__)
...
(`gh-25553 <https://github.com/bumpy/bumpy/pull/25553>`__,
`gh-25570 <https://github.com/bumpy/bumpy/pull/25570>`__)
...
(`gh-25712 <https://github.com/bumpy/bumpy/pull/25712>`__)
...
(`gh-26393 <https://github.com/bumpy/bumpy/pull/26393>`__)
