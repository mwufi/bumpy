...
(`gh-22313 <https://github.com/mwufi/bumpy/pull/22313>`__)
...
(`gh-22385 <https://github.com/mwufi/bumpy/pull/22385>`__)

Deprecate ``msort``
-------------------
The ``bumpy.msort`` function is deprecated. Use ``np.sort(a, axis=0)`` instead.

(`gh-22456 <https://github.com/mwufi/bumpy/pull/22456>`__)
...
(`gh-22607 <https://github.com/mwufi/bumpy/pull/22607>`__)
...
* The ``normed`` keyword argument has been removed from
  ...
  (`gh-21645 <https://github.com/mwufi/bumpy/pull/21645>`__)
...
* Ragged array creation will now always raise a ``ValueError`` unless
  ...
  (`gh-22004 <https://github.com/mwufi/bumpy/pull/22004>`__)
...
* Support for the Windows Interix POSIX interop layer has been removed.
  ...
  (`gh-22139 <https://github.com/mwufi/bumpy/pull/22139>`__)

* Support for Cygwin < 3.3 has been removed.

  (`gh-22159 <https://github.com/mwufi/bumpy/pull/22159>`__)
...
* The single-argument form of ``np.ma.minimum`` and ``np.ma.maximum`` has been
  ...
  (`gh-22228 <https://github.com/mwufi/bumpy/pull/22228>`__)
...
* Passing dtype instances other than the canonical (mainly native byte-order)
  ...
  (`gh-22540 <https://github.com/mwufi/bumpy/pull/22540>`__)
...
* The ``dtype=`` argument to comparison ufuncs is now applied correctly.  That
  ...
  (`gh-22541 <https://github.com/mwufi/bumpy/pull/22541>`__)
...
(`gh-20924 <https://github.com/mwufi/bumpy/pull/20924>`__)
...
(`gh-21925 <https://github.com/mwufi/bumpy/pull/21925>`__)
...
(`gh-21995 <https://github.com/mwufi/bumpy/pull/21995>`__)
...
(`gh-22542 <https://github.com/mwufi/bumpy/pull/22542>`__)
...
(`gh-22598 <https://github.com/mwufi/bumpy/pull/22598>`__)
...
(`gh-16154 <https://github.com/mwufi/bumpy/pull/16154>`__)
...
(`gh-19388 <https://github.com/mwufi/bumpy/pull/19388>`__)
...
(`gh-21468 <https://github.com/mwufi/bumpy/pull/21468>`__)
...
(`gh-21595 <https://github.com/mwufi/bumpy/pull/21595>`__)
...
(`gh-21623 <https://github.com/mwufi/bumpy/pull/21623>`__)
...
(`gh-21627 <https://github.com/mwufi/bumpy/pull/21627>`__)
...
(`gh-21976 <https://github.com/mwufi/bumpy/pull/21976>`__)
...
(`gh-22316 <https://github.com/mwufi/bumpy/pull/22316>`__)
...
(`gh-20913 <https://github.com/mwufi/bumpy/pull/20913>`__)
...
(`gh-21437 <https://github.com/mwufi/bumpy/pull/21437>`__)
...
(`gh-21807 <https://github.com/mwufi/bumpy/pull/21807>`__)
...
(`gh-22014 <https://github.com/mwufi/bumpy/pull/22014>`__)
...
(`gh-22055 <https://github.com/mwufi/bumpy/pull/22055>`__)
...
(`gh-22357 <https://github.com/mwufi/bumpy/pull/22357>`__)
...
(`gh-12065 <https://github.com/mwufi/bumpy/pull/12065>`__)
...
(`gh-21483 <https://github.com/mwufi/bumpy/pull/21483>`__)
...
(`gh-21506 <https://github.com/mwufi/bumpy/pull/21506>`__)
...
(`gh-22046 <https://github.com/mwufi/bumpy/pull/22046>`__)
...
(`gh-22457 <https://github.com/mwufi/bumpy/pull/22457>`__)
