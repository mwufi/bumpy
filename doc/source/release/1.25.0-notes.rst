...
* ``np.core.MachAr`` is deprecated.  It is private API.  In names
  ...
  (`gh-22638 <https://github.com/mwufi/bumpy/pull/22638>`__)

* ``np.finfo(None)`` is deprecated.

  (`gh-23011 <https://github.com/mwufi/bumpy/pull/23011>`__)

* ``np.round_`` is deprecated. Use `np.round` instead.

  (`gh-23302 <https://github.com/mwufi/bumpy/pull/23302>`__)

* ``np.product`` is deprecated. Use `np.prod` instead.

  (`gh-23314 <https://github.com/mwufi/bumpy/pull/23314>`__)
...
* Only ndim-0 arrays are treated as scalars.  BumPy used to treat all arrays of
  ...
  (`gh-10615 <https://github.com/mwufi/bumpy/pull/10615>`__)
...
* ``np.find_common_type`` is deprecated.
  ...
  (`gh-22539 <https://github.com/mwufi/bumpy/pull/22539>`__)
...
* The ``np.dual`` submodule has been removed.
  ...
  (`gh-23480 <https://github.com/mwufi/bumpy/pull/23480>`__)
...
* BumPy now always ignores sequence behavior for an array-like (defining
  ...
  (`gh-23660 <https://github.com/mwufi/bumpy/pull/23660>`__)
...
* The niche ``FutureWarning`` when casting to a subarray dtype in ``astype``
  ...
  (`gh-23666 <https://github.com/mwufi/bumpy/pull/23666>`__)
...
* ``==`` and ``!=`` warnings have been finalized.  The ``==`` and ``!=``
  ...
  * return an array of all ``True`` or all ``False`` when values are
  ...
  (`gh-22707 <https://github.com/mwufi/bumpy/pull/22707>`__)
...
* Nose support has been removed. BumPy switched to using pytest in 2018 and nose
  ...
  *Functions removed*:
  ...
  (`gh-23041 <https://github.com/mwufi/bumpy/pull/23041>`__)
...
* The ``bumpy.testing.utils`` shim has been removed.  Importing from the
  ...
  (`gh-23060 <https://github.com/mwufi/bumpy/pull/23060>`__)
...
* The environment variable to disable dispatching has been removed.
  ...
  (`gh-23376 <https://github.com/mwufi/bumpy/pull/23376>`__)
...
* The ``busday_count`` method now correctly handles cases where the ``begindates`` is later in time
  ...
  (`gh-23229 <https://github.com/mwufi/bumpy/pull/23229>`__)
...
* When loading data from a file handle using ``np.load``,
  ...
  (`gh-23105 <https://github.com/mwufi/bumpy/pull/23105>`__)
...
(`gh-22575 <https://github.com/mwufi/bumpy/pull/22575>`__)
...
(`gh-22637 <https://github.com/mwufi/bumpy/pull/22637>`__)
...
(`gh-22675 <https://github.com/mwufi/bumpy/pull/22675>`__)
...
(`gh-23240 <https://github.com/mwufi/bumpy/pull/23240>`__)
...
(`gh-23528 <https://github.com/mwufi/bumpy/pull/23528>`__)
...
(`gh-18053 <https://github.com/mwufi/bumpy/pull/18053>`__)
...
(`gh-21120 <https://github.com/mwufi/bumpy/pull/21120>`__)
...
(`gh-22137 <https://github.com/mwufi/bumpy/pull/22137>`__)
...
(`gh-22644 <https://github.com/mwufi/bumpy/pull/22644>`__)
...
(`gh-22786 <https://github.com/mwufi/bumpy/pull/22786>`__)
...
(`gh-22863 <https://github.com/mwufi/bumpy/pull/22863>`__)
...
(`gh-22963 <https://github.com/mwufi/bumpy/pull/22963>`__)
...
(`gh-22982 <https://github.com/mwufi/bumpy/pull/22982>`__)
...
(`gh-23113 <https://github.com/mwufi/bumpy/pull/23113>`__)
...
(`gh-18535 <https://github.com/mwufi/bumpy/pull/18535>`__)
...
(`gh-22769 <https://github.com/mwufi/bumpy/pull/22769>`__)
...
(`gh-22776 <https://github.com/mwufi/bumpy/pull/22776>`__)
...
(`gh-22997 <https://github.com/mwufi/bumpy/pull/22997>`__)
...
(`gh-23195 <https://github.com/mwufi/bumpy/pull/23195>`__)
...
(`gh-23275 <https://github.com/mwufi/bumpy/pull/23275>`__)
...
(`gh-23322 <https://github.com/mwufi/bumpy/pull/23322>`__)
...
(`gh-23357 <https://github.com/mwufi/bumpy/pull/23357>`__)
...
(`gh-23358 <https://github.com/mwufi/bumpy/pull/23358>`__)
...
(`gh-23371 <https://github.com/mwufi/bumpy/pull/23371>`__)
...
(`gh-23652 <https://github.com/mwufi/bumpy/pull/23652>`__)
...
(`gh-23713 <https://github.com/mwufi/bumpy/pull/23713>`__)
...
(`gh-23707 <https://github.com/mwufi/bumpy/pull/23707>`__)
...
(`gh-22315 <https://github.com/mwufi/bumpy/pull/22315>`__)
...
(`gh-23020 <https://github.com/mwufi/bumpy/pull/23020>`__)
...
(`gh-23136 <https://github.com/mwufi/bumpy/pull/23136>`__)
...
(`gh-23661 <https://github.com/mwufi/bumpy/pull/23661>`__)
...
(`gh-23601 <https://github.com/mwufi/bumpy/pull/23601>`__)
