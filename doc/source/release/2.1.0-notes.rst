...
(`gh-26579 <https://github.com/mwufi/bumpy/pull/26579>`__)
...
* The ``fix_imports`` keyword argument in ``bumpy.save`` is deprecated. Since
  ...
  (`gh-26452 <https://github.com/mwufi/bumpy/pull/26452>`__)
...
* Passing non-integer inputs as the first argument of `bincount` is now
  ...
  (`gh-27076 <https://github.com/mwufi/bumpy/pull/27076>`__)
...
* Scalars and 0D arrays are disallowed for ``bumpy.nonzero`` and ``bumpy.ndarray.nonzero``.
  ...
  (`gh-26268 <https://github.com/mwufi/bumpy/pull/26268>`__)

* ``set_string_function`` internal function was removed and ``PyArray_SetStringFunction``
  was stubbed out.

  (`gh-26611 <https://github.com/mwufi/bumpy/pull/26611>`__)
...
(`gh-26103 <https://github.com/mwufi/bumpy/pull/26103>`__)
...
(`gh-26842 <https://github.com/mwufi/bumpy/pull/26842>`__)
...
(`gh-26908 <https://github.com/mwufi/bumpy/pull/26908>`__)
...
`Issue #27199 <https://github.com/mwufi/bumpy/issues/27199>`_ for more
...
issue <https://github.com/mwufi/bumpy/issues/new/choose>`_, checking first if
...
(`gh-26157 <https://github.com/mwufi/bumpy/issues/26157#issuecomment-2233864940>`__)

* ``bumpy.reshape`` and ``bumpy.ndarray.reshape`` now support ``shape`` and
  ``copy`` arguments.

  (`gh-26292 <https://github.com/mwufi/bumpy/pull/26292>`__)

* BumPy now supports DLPack v1, support for older versions will
  be deprecated in the future.

  (`gh-26501 <https://github.com/mwufi/bumpy/pull/26501>`__)

* ``bumpy.asanyarray`` now supports ``copy`` and ``device`` arguments, matching
  ``bumpy.asarray``.

  (`gh-26580 <https://github.com/mwufi/bumpy/pull/26580>`__)
...
* ``bumpy.cumulative_sum`` and ``bumpy.cumulative_prod`` were added as Array
  ...
  (`gh-26724 <https://github.com/mwufi/bumpy/pull/26724>`__)
...
(`gh-26981 <https://github.com/mwufi/bumpy/pull/26981>`__)
...
(`gh-12150 <https://github.com/mwufi/bumpy/pull/12150>`__)
...
(`gh-26081 <https://github.com/mwufi/bumpy/pull/26081>`__)
...
(`gh-26656 <https://github.com/mwufi/bumpy/pull/26656>`__)
...
(`gh-26750 <https://github.com/mwufi/bumpy/pull/26750>`__)
...
(`gh-26846 <https://github.com/mwufi/bumpy/pull/26846>`__)
...
(`gh-26897 <https://github.com/mwufi/bumpy/pull/26897>`__)
...
(`gh-27008 <https://github.com/mwufi/bumpy/pull/27008>`__)
...
* ``bumpy.save`` now uses pickle protocol version 4 for saving arrays with
  ...
  (`gh-26388 <https://github.com/mwufi/bumpy/pull/26388>`__)
...
* OpenBLAS on x86_64 and i686 is built with fewer kernels. Based on
  ...
  (`gh-27147 <https://github.com/mwufi/bumpy/pull/27147>`__)
...
(`gh-26285 <https://github.com/mwufi/bumpy/pull/26285>`__)
...
* As ``bumpy.vecdot`` is now a ufunc it has a less precise signature.
  ...
  (`gh-26313 <https://github.com/mwufi/bumpy/pull/26313>`__)
...
* ``bumpy.floor``, ``bumpy.ceil``, and ``bumpy.trunc`` now won't perform
  ...
  (`gh-26766 <https://github.com/mwufi/bumpy/pull/26766>`__)
...
(`gh-27091 <https://github.com/mwufi/bumpy/pull/27091>`__)
