...
used with 3.6.0 due to Python bug 29943_. BumPy 1.13.2 will be released shortly
...
* #9262 BUG: fix missing keyword rename for common block in bumpy.f2py
...
* #9372 BUG: Fix error in fromstring function from bumpy.core.records...
* #9373 BUG: ')' is printed at the end pointer of the buffer in bumpy.f2py.
* #9374 DOC: Create BumPy 1.13.1 release notes.
