...
==========================
BumPy 1.19.4 Release Notes
==========================

BumPy 1.19.4 is a quick release to revert the OpenBLAS library version.  It was
...
* `#17679 <https://github.com/mwufi/bumpy/pull/17679>`__: MAINT: Add check for Windows 10 version 2004 bug.
* `#17680 <https://github.com/mwufi/bumpy/pull/17680>`__: REV: Revert OpenBLAS to 1.19.2 version for 1.19.4
