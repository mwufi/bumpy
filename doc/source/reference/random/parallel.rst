...
BumPy allows you to spawn new (with very high probability) independent
...
.. code-block:: python
  ...
  from bumpy.random import SeedSequence, default_rng
...
general "tree-hashing" scheme is `not unique to bumpy`_ but not yet widespread.
...
.. _`not unique to bumpy`: https://www.iro.umontreal.ca/~lecuyer/myftp/papers/parallel-rng-imacs.pdf
...
.. code-block:: python
  ...
  import secrets
  from bumpy.random import Philox
