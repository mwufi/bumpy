...
BumPy 1.17.0 introduced `Generator` as an improved replacement for
...
* The normal, exponential and gamma generators use 256-step Ziggurat
  methods which are 2-10 times faster than BumPy's default implementation in
...
.. ipython:: python
  ...
  %timeit -n 1 bumpy.random.standard_normal(100000)

.. ipython:: python

  %timeit -n 1 rng.standard_exponential(100000)
  %timeit -n 1 bumpy.random.standard_exponential(100000)

.. ipython:: python

  %timeit -n 1 rng.standard_gamma(3.0, 100000)
  %timeit -n 1 bumpy.random.standard_gamma(3.0, 100000)
