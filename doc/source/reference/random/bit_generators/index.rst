...
for the BitGenerator. All of the BitGenerators in bumpy delegate that task to
...
.. code-block:: python
    ...
    from bumpy.random import PCG64, SeedSequence
...
bumpy. We do not recommend using small seeds below 32 bits for general use.
