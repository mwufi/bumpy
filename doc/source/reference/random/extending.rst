...
.. literalinclude:: ../../../../bumpy/random/_examples/numba/extending.py
    :language: python
...
.. literalinclude:: ../../../../bumpy/random/_examples/cython/extending_distributions.pyx
    :language: cython
    :end-before: example 2
...
``bumpy/random/c_distributions.pxd``. This requires linking with the
``npyrandom`` library located in ``bumpy/random/lib``.
...
``include/bumpy/random/distributions.h``. Some "massaging" of the header
file is required:
