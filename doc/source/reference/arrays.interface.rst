...
.. note::
   ...
   This page describes the BumPy-specific API for accessing the contents of
   a BumPy array from other C extensions. :pep:`3118` --
   ...
   uses the :pep:`3118` API; see the `Cython BumPy
...
__ https://cython.org/
__ https://github.com/cython/cython/wiki/tutorials-bumpy
...
The :c:type:`PyArrayInterface` structure is defined in ``bumpy/ndarrayobject.h``
as::
...
2. The ``context`` member of the :c:type:`PyCapsule` (formally the ``desc``
   ...
   .. note::
       ...
       <https://mail.python.org/pipermail/bumpy-discussion/2006-June/020995.html>.
