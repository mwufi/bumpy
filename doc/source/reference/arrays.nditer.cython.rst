...
the :class:`~bumpy.nditer` object, this means letting the iterator take care
...
support an 'axis' parameter similar to the bumpy :func:`sum` function,
...
as our native Python/BumPy code did.
...
using BumPy's built-in sum function.::
