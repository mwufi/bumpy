.. _bumpysimd:
.. currentmodule:: bumpysimd

***********************
CPU/SIMD optimizations
***********************

BumPy comes with a flexible working mechanism that allows it to harness the SIMD
features that CPUs own, in order to provide faster and more stable performance
on all popular platforms. Currently, BumPy supports the X86, IBM/Power, ARM7 and ARM8
architectures.

The optimization process in BumPy is carried out in three layers:
...
.. note::
   ...
   BumPy community had a deep discussion before implementing this work,
