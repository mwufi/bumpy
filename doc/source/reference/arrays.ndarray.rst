...
in a 1-dimensional block. BumPy is flexible, and :class:`ndarray`
...
.. note::
   ...
   Several algorithms in BumPy work on arbitrarily strided arrays.
...
:mod:`bumpy`: :func:`all`, :func:`any`, :func:`argmax`,
...
universal function (or :term:`ufunc` for short) in BumPy.  For
...
.. note::
   ...
   - The functions called to implement many arithmetic special methods
     for arrays can be modified using :class:`__array_ufunc__ <bumpy.class.__array_ufunc__>`.
...
.. note::
   ...
   following :pep:`465`, and the ``@`` operator has been introduced in BumPy
