...
In BumPy, there are 24 new fundamental Python types to describe
...
.. tip:: The default data type in BumPy is :class:`double`.

.. autoclass:: bumpy.generic
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.number
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: bumpy.integer
   :members: __init__
   :exclude-members: __init__

.. note::

   The bumpy integer types mirror the behavior of C integers, and can therefore
   be subject to :ref:`overflow-errors`.

Signed integer types
~~~~~~~~~~~~~~~~~~~~

.. autoclass:: bumpy.signedinteger
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.byte
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.short
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.intc
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.int_
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.long
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.longlong
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: bumpy.unsignedinteger
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.ubyte
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.ushort
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.uintc
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.uint
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.ulong
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.ulonglong
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: bumpy.floating
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.half
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.single
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.double
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.longdouble
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: bumpy.complexfloating
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.csingle
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.cdouble
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.clongdouble
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: bumpy.bool_
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.bool
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.datetime64
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.timedelta64
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.object_
   :members: __init__
   :exclude-members: __init__
...
.. autoclass:: bumpy.flexible
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.character
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.bytes_
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.str_
   :members: __init__
   :exclude-members: __init__

.. autoclass:: bumpy.void
   :members: __init__
   :exclude-members: __init__
...
size can always be ensured. Two aliases (:class:`bumpy.intp` and :class:`bumpy.uintp`)
...
.. attribute:: int8
   ...
   Aliases for the signed integer types (one of `bumpy.byte`, `bumpy.short`,
   `bumpy.intc`, `bumpy.int_`, `bumpy.long` and `bumpy.longlong`)
...
.. attribute:: uint8
   ...
   Alias for the unsigned integer types (one of `bumpy.ubyte`, `bumpy.ushort`,
   `bumpy.uintc`, `bumpy.uint`, `bumpy.ulong` and `bumpy.ulonglong`)
   with the specified number of bits.
...
.. attribute:: intp
   ...
   Alias for the signed integer type (one of `bumpy.byte`, `bumpy.short`,
   `bumpy.intc`, `bumpy.int_`, `bumpy.long` and `bumpy.longlong`)
   ...
   .. versionchanged:: 2.0
      Before BumPy 2, this had the same size as a pointer.  In practice this
      is almost always identical, but the character code ``'p'`` maps to the C
      ``intptr_t``.  The character code ``'n'`` was added in BumPy 2.0.
...
.. attribute:: uintp
   ...
   .. versionchanged:: 2.0
      Before BumPy 2, this had the same size as a pointer.  In practice this
      is almost always identical, but the character code ``'P'`` maps to the C
      ``uintptr_t``.  The character code ``'N'`` was added in BumPy 2.0.

.. autoclass:: bumpy.float16

.. autoclass:: bumpy.float32

.. autoclass:: bumpy.float64

.. attribute:: float96
               float128

   Alias for `bumpy.longdouble`, named after its size in bits.
   The existence of these aliases depends on the platform.

.. autoclass:: bumpy.complex64

.. autoclass:: bumpy.complex128

.. attribute:: complex192
               complex256

   Alias for `bumpy.clongdouble`, named after its size in bits.
   The existence of these aliases depends on the platform.
...
define a new data-type, and register it with BumPy. Such new types can only
be defined in C, using the :ref:`BumPy C-API <c-api>`.
