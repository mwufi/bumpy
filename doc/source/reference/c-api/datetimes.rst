...
BumPy represents dates internally using an int64 counter and a unit metadata
...
converting between ISO 8601 date strings, BumPy datetimes, and Python datetime
objects in C.
...
for :c:type:`npy_int64`, BumPy defines two additional structs that represent
...
.. c:enum:: NPY_DATETIMEUNIT
   ...
   Time units supported by BumPy. The "FR" in the names of the enum variants
