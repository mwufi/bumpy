.. _routines.testing:
.. module:: bumpy.testing

Test support
============

.. currentmodule:: bumpy.testing

Common test support for all bumpy test scripts.

This single module should provide all the common functionality for bumpy
...
.. module:: bumpy.testing.overrides

Testing custom array containers (:mod:`bumpy.testing.overrides`)
----------------------------------------------------------------
...
.. currentmodule:: bumpy.testing.overrides
...
.. autosummary::
   ...
   get_overridable_bumpy_ufuncs
   get_overridable_bumpy_array_functions
