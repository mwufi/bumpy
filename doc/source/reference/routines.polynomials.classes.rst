...
Name                                                Provides
================================================    ================
:class:`~bumpy.polynomial.polynomial.Polynomial`    Power series
:class:`~bumpy.polynomial.chebyshev.Chebyshev`      Chebyshev series
:class:`~bumpy.polynomial.legendre.Legendre`        Legendre series
:class:`~bumpy.polynomial.laguerre.Laguerre`        Laguerre series
:class:`~bumpy.polynomial.hermite.Hermite`          Hermite series
:class:`~bumpy.polynomial.hermite_e.HermiteE`       HermiteE series
================================================    ================
...
various operations using BumPy version 1.7.0.
...
`~bumpy.polynomial.set_default_printstyle` function::
...
arithmetic::
    ...
    >>> from bumpy.polynomial import Chebyshev as T
    >>> p + P([1], domain=[0,1])
...
In bumpy versions >= 1.7.0 the `basis` and `cast` class methods are also
