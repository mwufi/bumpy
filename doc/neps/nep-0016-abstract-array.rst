...
Many functions, in BumPy and in third-party packages, start with some
code like::
...
``ndarray`` subclasses distributed with BumPy – ``np.matrix`` and
...
3. Begin migrating BumPy internal functions to using
...
stops either BumPy or third-parties from doing this in the future, but
...
* https://mail.python.org/pipermail/bumpy-discussion/2018-March/077767.html
