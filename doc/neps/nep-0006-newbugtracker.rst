...
Some release managers of both bumpy and scipy are becoming more and more
...
what to do at every step to contribute to bumpy or scipy:
...
may solve some of the issues.
        ...
        * Multi-project support: we have three trac instances, one for scipy,
          one for bumpy, one for scikits. Creating accounts, maintaining and
          ...
          Also, it happens quite frequently that a bug against bumpy is filled
...
Pros:
        ...
        * Conversion scripts from trac (no experience with it yet for bumpy/scipy).
