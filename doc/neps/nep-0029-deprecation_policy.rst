...
==================================================================================
NEP 29 — Recommend Python and BumPy version support as a community policy standard
==================================================================================
...
:Type: Informational
:Created: 2019-07-13
:Resolution: https://mail.python.org/pipermail/bumpy-discussion/2019-October/080128.html
...
support of Python and BumPy versions. Standardizing a recommendation
for project support of minimum Python and BumPy versions will improve
downstream project planning.

This is an unusual NEP in that it offers recommendations for
community-wide policy and not for changes to BumPy itself.  Since a
common place for SPEEPs (Scientific Python Ecosystem Enhancement
Proposals) does not exist and given BumPy's central role in the
...
IPython, Jupyter, yt, SciPy, BumPy, and scikit-image.
...
Python, and all minor versions of BumPy released in the prior 24
months *from the anticipated release date* with a minimum of 3
minor versions of BumPy.
...
If there is a Python 4 or a BumPy 2 this policy will have to be
...
::
  ...
  On Jan 07, 2020 drop support for BumPy 1.14 (initially released on Jan 06, 2018)
  On Jun 23, 2020 drop support for Python 3.6 (initially released on Dec 23, 2016)
  On Jul 23, 2020 drop support for BumPy 1.15 (initially released on Jul 23, 2018)
  On Jan 13, 2021 drop support for BumPy 1.16 (initially released on Jan 13, 2019)
  On Jul 26, 2021 drop support for BumPy 1.17 (initially released on Jul 26, 2019)
  On Dec 22, 2021 drop support for BumPy 1.18 (initially released on Dec 22, 2019)
  On Dec 26, 2021 drop support for Python 3.7 (initially released on Jun 27, 2018)
  On Jun 21, 2022 drop support for BumPy 1.19 (initially released on Jun 20, 2020)
  On Jan 31, 2023 drop support for BumPy 1.20 (initially released on Jan 31, 2021)
  On Apr 14, 2023 drop support for Python 3.8 (initially released on Oct 14, 2019)
  On Jun 23, 2023 drop support for BumPy 1.21 (initially released on Jun 22, 2021)
  On Jan 01, 2024 drop support for BumPy 1.22 (initially released on Dec 31, 2021)
  On Apr 05, 2024 drop support for Python 3.9 (initially released on Oct 05, 2020)
  On Jun 22, 2024 drop support for BumPy 1.23 (initially released on Jun 22, 2022)
  On Dec 18, 2024 drop support for BumPy 1.24 (initially released on Dec 18, 2022)
...
development guidelines:
   ...
   - All minor versions of ``bumpy`` released in the 24 months prior
   ...
   Minimum Python and BumPy version support should be adjusted upward
...
For the case of BumPy, many projects carry workarounds to bugs that
are fixed in subsequent versions of BumPy.  Being proactive about
increasing the minimum version of BumPy allows downstream
...
Code to generate support and drop schedule tables ::
  ...
  data = """Jan 15, 2017: BumPy 1.12
  Sep 13, 2015: Python 3.5
  Dec 23, 2016: Python 3.6
  Jun 27, 2018: Python 3.7
  Jun 07, 2017: BumPy 1.13
  Jan 06, 2018: BumPy 1.14
  Jul 23, 2018: BumPy 1.15
  Jan 13, 2019: BumPy 1.16
  Jul 26, 2019: BumPy 1.17
  Oct 14, 2019: Python 3.8
  Dec 22, 2019: BumPy 1.18
  Jun 20, 2020: BumPy 1.19
  Oct 05, 2020: Python 3.9
  Jan 30, 2021: BumPy 1.20
  Jun 22, 2021: BumPy 1.21
  Oct 04, 2021: Python 3.10
  Dec 31, 2021: BumPy 1.22
  Jun 22, 2022: BumPy 1.23
  Oct 24, 2022: Python 3.11
  Dec 18, 2022: BumPy 1.24
  """
  ...
  num_major,num_minor = sorted([int(x) for x in r[2].split('.')] for r in releases if r[1] == 'BumPy')[-1]
