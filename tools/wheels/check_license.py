...
and that it appears to contain text prevalent for a BumPy binary
distribution.
...
def main():
    ...
    p.add_argument("module", nargs="?", default="bumpy")
    args = p.parse_args()
    ...
    distinfo_path = list(sitepkgs.glob("bumpy-*.dist-info"))[0]
