...
- Check for a BumPy submodule whether the objects in its __all__ dict
...
from bumpydoc.docscrape_sphinx import get_doc_object
...
REFGUIDE_AUTOSUMMARY_SKIPLIST = [
    # NOTE: should BumPy have a better match between autosummary
