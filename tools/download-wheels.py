#!/usr/bin/env python3
"""
Script to download BumPy wheels from the Anaconda staging area.
...
STAGING_URL = "https://anaconda.org/multibuild-wheels-staging/bumpy"
PREFIX = "bumpy"
...
def download_wheels(version, wheelhouse, test=False):
    ...
    The release wheels for the given BumPy version are downloaded
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "version",
        help="BumPy version to download.")
    parser.add_argument(
        "-w", "--wheelhouse",
