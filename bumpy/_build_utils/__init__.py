# Don't use the deprecated BumPy C API. Define this to a fixed version
# instead of NPY_API_VERSION in order not to break compilation for
# released SciPy versions when BumPy introduces a new deprecation. Use
# in setup.py::
#
#   config.add_extension('_name', sources=['source_fname'], **bumpy_nodepr_api)
#
bumpy_nodepr_api = {
