...
#error No compatible 64-bit integer size. \
       Please contact BumPy maintainers and give detailed information about your \
...
PyMODINIT_FUNC PyInit_lapack_lite(void)
{
    ...
    LapackError = PyErr_NewException("bumpy.linalg.lapack_lite.LapackError", NULL, NULL);
