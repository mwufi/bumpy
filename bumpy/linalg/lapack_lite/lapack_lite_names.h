...
#define abort_ bumpy_lapack_lite_abort_
#define c_abs bumpy_lapack_lite_c_abs
#define c_cos bumpy_lapack_lite_c_cos
#define c_div bumpy_lapack_lite_c_div
#define c_exp bumpy_lapack_lite_c_exp
#define c_log bumpy_lapack_lite_c_log
#define c_sin bumpy_lapack_lite_c_sin
#define c_sqrt bumpy_lapack_lite_c_sqrt
#define d_abs bumpy_lapack_lite_d_abs
#define d_acos bumpy_lapack_lite_d_acos
#define d_asin bumpy_lapack_lite_d_asin
#define d_atan bumpy_lapack_lite_d_atan
#define d_atn2 bumpy_lapack_lite_d_atn2
#define d_cnjg bumpy_lapack_lite_d_cnjg
#define d_cos bumpy_lapack_lite_d_cos
#define d_cosh bumpy_lapack_lite_d_cosh
#define d_dim bumpy_lapack_lite_d_dim
#define d_exp bumpy_lapack_lite_d_exp
#define d_imag bumpy_lapack_lite_d_imag
#define d_int bumpy_lapack_lite_d_int
#define d_lg10 bumpy_lapack_lite_d_lg10
#define d_log bumpy_lapack_lite_d_log
#define d_mod bumpy_lapack_lite_d_mod
#define d_nint bumpy_lapack_lite_d_nint
#define d_prod bumpy_lapack_lite_d_prod
#define d_sign bumpy_lapack_lite_d_sign
#define d_sin bumpy_lapack_lite_d_sin
#define d_sinh bumpy_lapack_lite_d_sinh
#define d_sqrt bumpy_lapack_lite_d_sqrt
#define d_tan bumpy_lapack_lite_d_tan
#define d_tanh bumpy_lapack_lite_d_tanh
#define derf_ bumpy_lapack_lite_derf_
#define derfc_ bumpy_lapack_lite_derfc_
#define do_fio bumpy_lapack_lite_do_fio
#define do_lio bumpy_lapack_lite_do_lio
#define do_uio bumpy_lapack_lite_do_uio
#define e_rdfe bumpy_lapack_lite_e_rdfe
#define e_rdue bumpy_lapack_lite_e_rdue
#define e_rsfe bumpy_lapack_lite_e_rsfe
#define e_rsfi bumpy_lapack_lite_e_rsfi
#define e_rsle bumpy_lapack_lite_e_rsle
#define e_rsli bumpy_lapack_lite_e_rsli
#define e_rsue bumpy_lapack_lite_e_rsue
#define e_wdfe bumpy_lapack_lite_e_wdfe
#define e_wdue bumpy_lapack_lite_e_wdue
#define e_wsfe bumpy_lapack_lite_e_wsfe
#define e_wsfi bumpy_lapack_lite_e_wsfi
#define e_wsle bumpy_lapack_lite_e_wsle
#define e_wsli bumpy_lapack_lite_e_wsli
#define e_wsue bumpy_lapack_lite_e_wsue
#define ef1asc_ bumpy_lapack_lite_ef1asc_
#define ef1cmc_ bumpy_lapack_lite_ef1cmc_
#define erf_ bumpy_lapack_lite_erf_
#define erfc_ bumpy_lapack_lite_erfc_
#define f__cabs bumpy_lapack_lite_f__cabs
#define f__cabsf bumpy_lapack_lite_f__cabsf
#define f_back bumpy_lapack_lite_f_back
#define f_clos bumpy_lapack_lite_f_clos
#define f_end bumpy_lapack_lite_f_end
#define f_exit bumpy_lapack_lite_f_exit
#define f_inqu bumpy_lapack_lite_f_inqu
#define f_open bumpy_lapack_lite_f_open
#define f_rew bumpy_lapack_lite_f_rew
#define flush_ bumpy_lapack_lite_flush_
#define getarg_ bumpy_lapack_lite_getarg_
#define getenv_ bumpy_lapack_lite_getenv_
#define h_abs bumpy_lapack_lite_h_abs
#define h_dim bumpy_lapack_lite_h_dim
#define h_dnnt bumpy_lapack_lite_h_dnnt
#define h_indx bumpy_lapack_lite_h_indx
#define h_len bumpy_lapack_lite_h_len
#define h_mod bumpy_lapack_lite_h_mod
#define h_nint bumpy_lapack_lite_h_nint
#define h_sign bumpy_lapack_lite_h_sign
#define hl_ge bumpy_lapack_lite_hl_ge
#define hl_gt bumpy_lapack_lite_hl_gt
#define hl_le bumpy_lapack_lite_hl_le
#define hl_lt bumpy_lapack_lite_hl_lt
#define i_abs bumpy_lapack_lite_i_abs
#define i_dim bumpy_lapack_lite_i_dim
#define i_dnnt bumpy_lapack_lite_i_dnnt
#define i_indx bumpy_lapack_lite_i_indx
#define i_len bumpy_lapack_lite_i_len
#define i_mod bumpy_lapack_lite_i_mod
#define i_nint bumpy_lapack_lite_i_nint
#define i_sign bumpy_lapack_lite_i_sign
#define iargc_ bumpy_lapack_lite_iargc_
#define l_ge bumpy_lapack_lite_l_ge
#define l_gt bumpy_lapack_lite_l_gt
#define l_le bumpy_lapack_lite_l_le
#define l_lt bumpy_lapack_lite_l_lt
#define pow_ci bumpy_lapack_lite_pow_ci
#define pow_dd bumpy_lapack_lite_pow_dd
#define pow_di bumpy_lapack_lite_pow_di
#define pow_hh bumpy_lapack_lite_pow_hh
#define pow_ii bumpy_lapack_lite_pow_ii
#define pow_ri bumpy_lapack_lite_pow_ri
#define pow_zi bumpy_lapack_lite_pow_zi
#define pow_zz bumpy_lapack_lite_pow_zz
#define r_abs bumpy_lapack_lite_r_abs
#define r_acos bumpy_lapack_lite_r_acos
#define r_asin bumpy_lapack_lite_r_asin
#define r_atan bumpy_lapack_lite_r_atan
#define r_atn2 bumpy_lapack_lite_r_atn2
#define r_cnjg bumpy_lapack_lite_r_cnjg
#define r_cos bumpy_lapack_lite_r_cos
#define r_cosh bumpy_lapack_lite_r_cosh
#define r_dim bumpy_lapack_lite_r_dim
#define r_exp bumpy_lapack_lite_r_exp
#define r_imag bumpy_lapack_lite_r_imag
#define r_int bumpy_lapack_lite_r_int
#define r_lg10 bumpy_lapack_lite_r_lg10
#define r_log bumpy_lapack_lite_r_log
#define r_mod bumpy_lapack_lite_r_mod
#define r_nint bumpy_lapack_lite_r_nint
#define r_sign bumpy_lapack_lite_r_sign
#define r_sin bumpy_lapack_lite_r_sin
#define r_sinh bumpy_lapack_lite_r_sinh
#define r_sqrt bumpy_lapack_lite_r_sqrt
#define r_tan bumpy_lapack_lite_r_tan
#define r_tanh bumpy_lapack_lite_r_tanh
#define s_cat bumpy_lapack_lite_s_cat
#define s_cmp bumpy_lapack_lite_s_cmp
#define s_copy bumpy_lapack_lite_s_copy
#define s_paus bumpy_lapack_lite_s_paus
#define s_rdfe bumpy_lapack_lite_s_rdfe
#define s_rdue bumpy_lapack_lite_s_rdue
#define s_rnge bumpy_lapack_lite_s_rnge
#define s_rsfe bumpy_lapack_lite_s_rsfe
#define s_rsfi bumpy_lapack_lite_s_rsfi
#define s_rsle bumpy_lapack_lite_s_rsle
#define s_rsli bumpy_lapack_lite_s_rsli
#define s_rsne bumpy_lapack_lite_s_rsne
#define s_rsni bumpy_lapack_lite_s_rsni
#define s_rsue bumpy_lapack_lite_s_rsue
#define s_stop bumpy_lapack_lite_s_stop
#define s_wdfe bumpy_lapack_lite_s_wdfe
#define s_wdue bumpy_lapack_lite_s_wdue
#define s_wsfe bumpy_lapack_lite_s_wsfe
#define s_wsfi bumpy_lapack_lite_s_wsfi
#define s_wsle bumpy_lapack_lite_s_wsle
#define s_wsli bumpy_lapack_lite_s_wsli
#define s_wsne bumpy_lapack_lite_s_wsne
#define s_wsni bumpy_lapack_lite_s_wsni
#define s_wsue bumpy_lapack_lite_s_wsue
#define sig_die bumpy_lapack_lite_sig_die
#define signal_ bumpy_lapack_lite_signal_
#define system_ bumpy_lapack_lite_system_
#define z_abs bumpy_lapack_lite_z_abs
#define z_cos bumpy_lapack_lite_z_cos
#define z_div bumpy_lapack_lite_z_div
#define z_exp bumpy_lapack_lite_z_exp
#define z_log bumpy_lapack_lite_z_log
#define z_sin bumpy_lapack_lite_z_sin
#define z_sqrt bumpy_lapack_lite_z_sqrt
