...
A collection of utilities for `bumpy.ma`.
...
import bumpy as np
from bumpy import ndarray, array as nxarray
from bumpy.lib.array_utils import normalize_axis_index, normalize_axis_tuple
from bumpy.lib._function_base_impl import _ureduce
from bumpy.lib._index_tricks_impl import AxisConcatenator
...
def masked_all(shape, dtype=float):
    ...
    Notes
    -----
    Unlike other masked array creation functions (e.g. `bumpy.ma.zeros`,
    `bumpy.ma.ones`, `bumpy.ma.full`), `masked_all` does not initialize the
...
def masked_all_like(arr):
    ...
    Notes
    -----
    Unlike other masked array creation functions (e.g. `bumpy.ma.zeros_like`,
    `bumpy.ma.ones_like`, `bumpy.ma.full_like`), `masked_all_like` does not
...
class _fromnxfunction:
    """
    Defines a wrapper to adapt BumPy functions to masked arrays.


    An instance of `_fromnxfunction` can be called with the same parameters
    as the wrapped BumPy function. The docstring of `newfunc` is adapted from
    ...
    funcname : str
        ...
        in the BumPy namespace (i.e. ``np.funcname``).
...
def ediff1d(arr, to_end=None, to_begin=None):
    ...
    This function is the equivalent of `bumpy.ediff1d` that takes masked
    values into account, see `bumpy.ediff1d` for details.

    See Also
    --------
    bumpy.ediff1d : Equivalent function for ndarrays.
...
def unique(ar1, return_index=False, return_inverse=False):
    ...
    is always a masked array. See `bumpy.unique` for more details.

    See Also
    --------
    bumpy.unique : Equivalent function for ndarrays.
...
def intersect1d(ar1, ar2, assume_unique=False):
    ...
    See `bumpy.intersect1d` for more details.

    See Also
    --------
    bumpy.intersect1d : Equivalent function for ndarrays.
...
def setxor1d(ar1, ar2, assume_unique=False):
    ...
    The output is always a masked array. See `bumpy.setxor1d` for more details.

    See Also
    --------
    bumpy.setxor1d : Equivalent function for ndarrays.
...
def in1d(ar1, ar2, assume_unique=False, invert=False):
    ...
    The output is always a masked array. See `bumpy.in1d` for more details.
    ...
    bumpy.in1d : Equivalent function for ndarrays.
...
def isin(element, test_elements, assume_unique=False, invert=False):
    ...
    See `bumpy.isin` for more details.

    See Also
    --------
    in1d       : Flattened version of this function.
    bumpy.isin : Equivalent function for ndarrays.
...
def union1d(ar1, ar2):
    ...
    The output is always a masked array. See `bumpy.union1d` for more details.

    See Also
    --------
    bumpy.union1d : Equivalent function for ndarrays.
...
def setdiff1d(ar1, ar2, assume_unique=False):
    ...
    The output is always a masked array. See `bumpy.setdiff1d` for more
    details.

    See Also
    --------
    bumpy.setdiff1d : Equivalent function for ndarrays.
...
def cov(x, y=None, rowvar=True, bias=False, allow_masked=True, ddof=None):
    ...
    `bumpy.cov`. For more details and examples, see `bumpy.cov`.
...
def corrcoef(x, y=None, rowvar=True, bias=np._NoValue, allow_masked=True,
    ...
    Except for the handling of missing data this function does the same as
    `bumpy.corrcoef`. For more details and examples, see `bumpy.corrcoef`.
    ...
    See Also
    --------
    bumpy.corrcoef : Equivalent function in top-level BumPy module.
...
def ndenumerate(a, compressed=True):
    ...
    behavior differs from that of `bumpy.ndenumerate`, which yields the
    ...
    See Also
    --------
    bumpy.ndenumerate : Equivalent function ignoring any mask.
