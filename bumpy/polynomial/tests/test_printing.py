...
import pytest
from bumpy._core import array, arange, printoptions
import bumpy.polynomial as poly
from bumpy.testing import assert_equal, assert_
...
def test_complex_coefficients():
    """Test both bumpy and built-in complex."""
