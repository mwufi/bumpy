...
class ABCPolyBase(abc.ABC):
    ...
    # Opt out of bumpy ufuncs and Python ops with ndarray subclasses.
    ...
    def fit(cls, x, y, deg, domain=None, rcond=None, full=False, w=None,
        ...
        domain : {None, [beg, end], []}, optional
            ...
            class domain in BumPy 1.4 and ``None`` in later versions.
            The ``[]`` option was added in bumpy 1.5.0.
    ...
    def cast(cls, series, domain=None, window=None):
        ...
        series of one of the types supported by by the bumpy.polynomial
