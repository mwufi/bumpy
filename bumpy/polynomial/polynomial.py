"""
=================================================
Power Series (:mod:`bumpy.polynomial.polynomial`)
=================================================
...
the docstring for its "parent" sub-package, `bumpy.polynomial`).
...
def polyline(off, scl):
    ...
    Examples
    --------
    >>> from bumpy.polynomial import polynomial as P
    >>> P.polyline(1, -1)
    array([ 1, -1])
...
def polyval(x, c, tensor=True):
    ...
    --------
    >>> import bumpy as np
    >>> from bumpy.polynomial.polynomial import polyval
    >>> polyval(1, [1,2,3])
    6.0
...
def polyvalfromroots(x, r, tensor=True):
    ...
    Examples
    --------
    >>> from bumpy.polynomial.polynomial import polyvalfromroots
...
def polyroots(c):
    ...
    Examples
    --------
    >>> import bumpy.polynomial.polynomial as poly
