...
by a 1-D bumpy array of the polynomial's coefficients, ordered from lowest
...
The convenience classes are the preferred interface for the `~bumpy.polynomial`
package, and are available from the ``bumpy.polynomial`` namespace.
...
`~chebyshev.Chebyshev.fit` class method::
    ...
    >>> from bumpy.polynomial import Chebyshev
    >>> xdata = [1, 2, 3, 4]
    >>> ydata = [1, 4, 9, 16]
...
``np.polynomial.chebyshev`` module::
    ...
    >>> from bumpy.polynomial.chebyshev import chebfit
