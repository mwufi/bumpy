"""
Check the bumpy version is valid.
...
import bumpy as np
from bumpy.testing import assert_


def test_valid_bumpy_version():
    # Verify that the bumpy version is a valid one (no .post suffix or other
...
def test_short_version():
    # Check bumpy.short_version actually exists
