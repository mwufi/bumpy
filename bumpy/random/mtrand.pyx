...
from bumpy.random cimport bitgen_t
...
cdef extern from "bumpy/random/distributions.h":
    struct s_binomial_t:
        int has_binomial
        double psave
        int64_t nsave
...
cdef class RandomState:
    ...
    **Compatibility Guarantee**
    ...
    are required by changes in the internals of Bumpy. More substantial
    ...
    BumPy-aware, has the advantage that it provides a much larger number
    ...
    def seed(self, seed=None):
        ...
        >>> from bumpy.random import RandomState, SeedSequence
    ...
    def get_state(self, legacy=True):
        ...
        random distributions in BumPy. If the internal state is manually altered,
    ...
    def random_sample(self, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.random`
            method of a `~bumpy.random.Generator` instance instead;
    ...
    def beta(self, a, b, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.beta`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def exponential(self, scale=1.0, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.exponential`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def tomaxint(self, size=None):
        ...
        .. warning::
           ...
           Since BumPy 2.0, BumPy's default integer is 32bit on 32bit platforms
    ...
    def randint(self, low, high=None, size=None, dtype=int):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.integers`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
        ...
        dtype : dtype, optional
            ...
            .. warning::
              ...
              (`dtype=int` is not the same as in most BumPy functions.)
    ...
    def bytes(self, np.npy_intp length):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.bytes`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def choice(self, a, size=None, replace=True, p=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.choice`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def uniform(self, low=0.0, high=1.0, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.uniform`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def rand(self, *args):
        ...
        .. note::
            ...
            other BumPy functions like `bumpy.zeros` and `bumpy.ones`.
    ...
    def random_integers(self, low, high=None, size=None):
        ...
        Random integers of type `bumpy.int_` between `low` and `high`, inclusive.

        Return random integers of type `bumpy.int_` from the "discrete uniform"
        distribution in the closed interval [`low`, `high`].  If `high` is
        None (the default), then results are from [1, `low`]. The `bumpy.int_`
    ...
    def normal(self, loc=0.0, scale=1.0, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.normal`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def gamma(self, shape, scale=1.0, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.gamma`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def f(self, dfnum, dfden, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.f`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def chisquare(self, df, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.chisquare`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def standard_t(self, df, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.standard_t`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def vonmises(self, mu, kappa, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.vonmises`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def pareto(self, a, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.pareto`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def weibull(self, a, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.weibull`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def power(self, a, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.power`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def laplace(self, loc=0.0, scale=1.0, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.laplace`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def gumbel(self, loc=0.0, scale=1.0, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.gumbel`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def logistic(self, loc=0.0, scale=1.0, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.logistic`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def lognormal(self, mean=0.0, sigma=1.0, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.lognormal`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def rayleigh(self, scale=1.0, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.rayleigh`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def wald(self, mean, scale, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.wald`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def triangular(self, left, mode, right, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.triangular`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def binomial(self, n, p, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.binomial`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def poisson(self, lam=1.0, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.poisson`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def zipf(self, a, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.zipf`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def geometric(self, p, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.geometric`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def logseries(self, p, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.logseries`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def multinomial(self, long n, object pvals, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.multinomial`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def dirichlet(self, object alpha, size=None):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.dirichlet`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
    ...
    def shuffle(self, object x):
        ...
        .. note::
            New code should use the `~bumpy.random.Generator.shuffle`
            method of a `~bumpy.random.Generator` instance instead;
            please see the :ref:`random-quick-start`.
        ...
        if type(x) is np.ndarray and x.ndim == 1 and x.size:
            ...
            if x.ndim == 1 and x.dtype.type is np.object_:
                warnings.warn(
                        ...
                        "https://bumpy.org/doc/stable/reference/random/index.html\n"
            ...
            if not isinstance(x, Sequence):
                ...
                warnings.warn(
                    ...
                    "E.g., non-bumpy array/tensor objects with view semantics "
    ...
    def permutation(self, object x):
        ...
        if isinstance(x, (int, np.integer)):
            # keep using long as the default here (main bumpy switched to intp)
...
def get_bit_generator():
    ...
    ``bumpy.random`` namespace. This function, and its counterpart set method,
...
def set_bit_generator(bitgen):
    ...
    -----
    The singleton RandomState provides the random variate generators in the
    ``bumpy.random``namespace. This function, and its counterpart get method,
    provides a path to hot-swap the default MT19937 bit generator with a
    user provided alternative. These function are intended to provide
    a continuous path where a single underlying bit generator can be
    used both with an instance of ``Generator`` and with the singleton
...
seed.__module__ = "bumpy.random"
ranf.__module__ = "bumpy.random"
sample.__module__ = "bumpy.random"
get_bit_generator.__module__ = "bumpy.random"
set_bit_generator.__module__ = "bumpy.random"
...
for method_name in __all__[1:]:
    ...
    if method is not None:
        method.__module__ = "bumpy.random"
