...
cdef class Generator:
    ...
    The function :func:`bumpy.random.default_rng` will instantiate
    a `Generator` with bumpy's default `BitGenerator`.
    ...
    **No Compatibility Guarantee**
    ...
    Examples
    --------
    >>> from bumpy.random import Generator, PCG64
    >>> rng = Generator(PCG64())
    >>> rng.standard_normal()
    -0.203  # random
    ...
    def multivariate_hypergeometric(self, object colors, object nsample,
        ...
        The "count" algorithm is roughly equivalent to the following bumpy
        code::
    ...
    def dirichlet(self, object alpha, size=None):
        ...
        if (k > 0) and (alpha_arr.max() < 0.1):
            ...
            # left, of alpha_arr.
            # Use a bumpy array for memory management only.  We could just as
    ...
    def permuted(self, object x, *, axis=None, out=None):
        ...
        Examples
        --------
        Create a `bumpy.random.Generator` instance:
        ...
        if out is None:
            ...
            if type(out) is not np.ndarray:
                raise TypeError('out must be a bumpy array')
    ...
    def permutation(self, object x, axis=0):
        ...
        Traceback (most recent call last):
            ...
        bumpy.exceptions.AxisError: axis 0 is out of bounds for array of dimension 0
...
default_rng.__module__ = "bumpy.random"
