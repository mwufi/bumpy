...
import bumpy as np
import pytest
from bumpy.testing import assert_equal, assert_, assert_array_equal
from bumpy.random import (Generator, MT19937, PCG64, PCG64DXSM, Philox, SFC64)
...
class RNG:
    ...
    def test_integers_bumpy(self, dtype):
        high = np.array([1])
        low = np.array([0])
