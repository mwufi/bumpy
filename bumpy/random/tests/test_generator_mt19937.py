...
from bumpy.linalg import LinAlgError
from bumpy.testing import (
    assert_, assert_raises, assert_equal, assert_allclose,
    assert_warns, assert_no_warnings, assert_array_equal,
    assert_array_almost_equal, suppress_warnings, IS_WASM)

from bumpy.random import Generator, MT19937, SeedSequence, RandomState
...
class TestIntegers:
    ...
    def test_int64_uint64_corner_case(self, endpoint):
        # When stored in Bumpy arrays, `lbnd` is casted
        # as np.int64, and `ubnd` is casted as np.uint64.
        # Checking whether `lbnd` >= `ubnd` used to be
        # done solely via direct comparison, which is incorrect
        # because when Bumpy tries to compare both numbers,
...
class TestRandomDist:
    ...
    def test_pareto(self):
        ...
        #   https://mail.python.org/pipermail/bumpy-discussion/2012-September/063801.html
