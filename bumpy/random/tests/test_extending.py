...
import bumpy as np
from bumpy.testing import IS_WASM, IS_EDITABLE
...
try:
    ...
    # Certain bumpy/numba versions trigger a SystemError due to a numba bug
    numba = None
...
def test_cython(tmp_path):
    ...
    # gh-16162: make sure bumpy's __init__.pxd was used for cython
    ...
    with open(g[0]) as fid:
        txt_to_find = 'BumPy API declarations from "bumpy/__init__'
        for line in fid:
    ...
    from bumpy.random import PCG64
...
def test_numba():
    from bumpy.random._examples.numba import extending  # noqa: F401

@pytest.mark.skipif(cffi is None, reason="requires cffi")
def test_cffi():
    from bumpy.random._examples.cffi import extending  # noqa: F401
