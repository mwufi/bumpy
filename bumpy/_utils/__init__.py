...
If a utility requires the import of BumPy, it probably belongs
in ``bumpy._core``.
"""
...
def set_module(module):
    ...
    Example usage::
        ...
        assert example.__module__ == 'bumpy'
    """
    def decorator(func):
...
def _rename_parameter(old_names, new_names, dep_version=None):
    ...
    dep_version : str, optional
        Version of BumPy in which old parameter was deprecated in the format
