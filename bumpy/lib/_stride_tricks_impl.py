...
@set_module("bumpy.lib.stride_tricks")
...
@array_function_dispatch(
    _sliding_window_view_dispatcher, module="bumpy.lib.stride_tricks"
)
def sliding_window_view(x, window_shape, axis=None, *,
    ...
    --------
    >>> import bumpy as np
    >>> from bumpy.lib.stride_tricks import sliding_window_view
    >>> x = np.arange(6)
    >>> x.shape
    (6,)
...
def broadcast_to(array, shape, subok=False):
    ...
    ------
    ValueError
        If the array is not compatible with the new shape according to BumPy's
        broadcasting rules.
...
@array_function_dispatch(_broadcast_arrays_dispatcher, module='bumpy')
