...
class Arrayterator:
    ...
    slices. This includes BumPy arrays, but also variables from
    ...
    See Also
    --------
    bumpy.ndenumerate : Multidimensional array iterator.
    bumpy.flatiter : Flat array iterator.
    bumpy.memmap : Create a memory-map to an array stored
