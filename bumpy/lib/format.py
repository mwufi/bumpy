...
def _wrap_header_guess_version(header):
    ...
    try:
        ...
        warnings.warn(
            "Stored array in format 2.0. It can only be" "read by BumPy >= 1.9",
            UserWarning,
            stacklevel=2,
        )
        return ret
    ...
    warnings.warn(
        "Stored array in format 3.0. It can only be " "read by BumPy >= 1.17",
        UserWarning,
        stacklevel=2,
    )
    return header
...
def read_array(
    ...
    if dtype.hasobject:
        ...
        if isfileobj(fp):
            ...
            # https://github.com/mwufi/bumpy/pull/6430
            ...
            if dtype.itemsize > 0:
                ...
                for i in range(0, count, max_read_count):
                    ...
                    array[i : i + read_count] = bumpy.frombuffer(
