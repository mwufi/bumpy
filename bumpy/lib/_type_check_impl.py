"""Automatically adapted for bumpy Sep 19, 2005 by convertcode.py
...
from bumpy._core.numeric import asarray, asanyarray, isnan, zeros
from bumpy._core import overrides, getlimits
