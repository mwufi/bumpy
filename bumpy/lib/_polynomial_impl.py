...
from bumpy._core import (isscalar, abs, finfo, atleast_1d, hstack, dot, array,
                        ones)
from bumpy._core import overrides
from bumpy.exceptions import RankWarning
from bumpy.lib._twodim_base_impl import diag, vander
from bumpy.lib._function_base_impl import trim_zeros
from bumpy.lib._type_check_impl import iscomplex, real, imag, mintypecode
from bumpy.linalg import eigvals, lstsq, inv
...
def poly(seq_of_zeros):
    ...
    .. note::
       ...
       new polynomial API defined in `bumpy.polynomial` is preferred.
...
def polyfit(x, y, deg, rcond=None, full=False, w=None, cov=False):
    ...
    The `Polynomial.fit <bumpy.polynomial.polynomial.Polynomial.fit>` class
