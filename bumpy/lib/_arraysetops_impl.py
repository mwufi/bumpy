...
`bumpy.sort`, that can provide directly the permutation vectors, thus avoiding
calls to `bumpy.argsort`.
...
def unique(
    ...
    * the number of times each unique value comes up in the input array
    ...
    .. versionchanged:: 2.0
        ...
        Note that in BumPy 2.0.0 a higher dimensional array was returned also
...
def _in1d(ar1, ar2, assume_unique=False, invert=False, *, kind=None):
    ...
    if use_table_method:
        ...
        # https://github.com/mwufi/bumpy/pull/12065.
