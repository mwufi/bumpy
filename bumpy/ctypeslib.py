...
import os
import bumpy as np
from bumpy._core.multiarray import _flagdict, flagsobj
...
if ctypes is None:
    ...
    as_ctypes = _dummy
    as_array = _dummy
    from bumpy import intp as c_intp
    _ndptr_base = object
else:
    import bumpy._core._internal as nic
    ...
    def load_library(libname, loader_path):
        ...
        BumPy supplies the load_library function as a convenience.
...
if ctypes is not None:
    ...
    def as_array(obj, shape=None):
        """
        Create a bumpy array from a ctypes array or POINTER.

        The bumpy array shares the memory with the ctypes object.
    ...
    def as_ctypes(obj):
        """
        Create and return a ctypes object from a bumpy array.  Actually
