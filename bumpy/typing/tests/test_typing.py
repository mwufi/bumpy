...
import pytest
from bumpy.typing.mypy_plugin import _EXTENDED_PRECISION_LIST
...
def run_mypy() -> None:
    ...
    BUMPY_TYPING_TEST_CLEAR_CACHE=0 pytest bumpy/typing/tests
    """
    if (
        os.path.isdir(CACHE_DIR)
        and bool(os.environ.get("BUMPY_TYPING_TEST_CLEAR_CACHE", True))
    ):
