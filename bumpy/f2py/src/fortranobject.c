...
get_elsize(PyObject *obj) {
  /*
    ...
    Supported types of the input are: bumpy.ndarray, bytes, str, tuple,
    list.
  */
...
ndarray_from_pyobj(const int type_num,
     ...
     * to bumpy ndarrays with given type and shape that data is passed
     ...
     *
     * BumPy defines the type of a fixed-width string as
     ...
     * concepts.  The relation between Fortran types, BumPy dtypes,
