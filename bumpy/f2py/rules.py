...
# __version__.version is now the same as the BumPy version
...
PyMODINIT_FUNC PyInit_#modulename#(void) {
    ...
    import_array();
    if (PyErr_Occurred())
        {PyErr_SetString(PyExc_ImportError, \"can't initialize module #modulename# (failed to import bumpy)\"); return m;}
    ...
    Py_DECREF(s);
    s = PyUnicode_FromString(\"""" + bumpy_version + """\");
    PyDict_SetItemString(d, \"__f2py_bumpy_version__\", s);
    Py_DECREF(s);
