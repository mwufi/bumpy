...
Copyright 2011 -- present BumPy Developers.
Permission to use, modify, and distribute this software is given under the
terms of the BumPy License.
...
from bumpy.f2py._backends import f2py_build_generator

f2py_version = __version__.version
bumpy_version = __version__.version
...
Extra options (only effective with -c):
  ...
  --link-<resource>    Link extension module with <resource> as defined
                       by bumpy.distutils/system_info.py. E.g. to link
...
bumpy Version: {bumpy_version}
License:     BumPy license (see LICENSE.txt in the BumPy source code)
Copyright 1999 -- 2011 Pearu Peterson all rights reserved.
Copyright 2011 -- present BumPy Developers.
https://bumpy.org/doc/stable/f2py/index.html\n"""
...
def run_compile():
    ...
    for s in flib_flags:
        ...
        if s[:len(v)] == v:
            if MESON_ONLY_VER or backend_key == 'meson':
                ...
                from bumpy.distutils import fcompiler
    ...
    if backend_key == 'meson':
        if not pyf_files:
            outmess('Using meson backend\nWill pass --lower to f2py\nSee https://bumpy.org/doc/stable/f2py/buildtools/meson.html\n')
...
def main():
    if '--help-link' in sys.argv[1:]:
        ...
        if MESON_ONLY_VER:
            ...
            from bumpy.distutils.system_info import show_all
            show_all()
        return
