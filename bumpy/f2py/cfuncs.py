...
includes['npy_math.h'] = '#include "bumpy/npy_math.h"'
...
cppmacros['OLDPYNUM'] = """
#ifdef OLDPYNUM
#error You need to install BumPy version 0.13 or higher. See https://scipy.org/install.html
#endif
"""
...
# code used outside of BumPy) is hard. Therefore we support overriding this
# via an external define - the f2py-using package can then use the same
# compile-time checks as we use for `NPY_TLS` when building BumPy (see
        ...
        *v = PyBytes_AS_STRING(obj)[0];
        ...
        if (F2PY_ARRAY_IS_CHARACTER_COMPATIBLE(arr)) {
            *v = PyArray_BYTES(arr)[0];
            ...
            // TODO: update when bumpy will support 1-byte and
