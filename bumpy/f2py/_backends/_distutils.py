...
from bumpy.distutils.core import setup, Extension
from bumpy.distutils.system_info import get_info
from bumpy.distutils.misc_util import dict_append
...
class DistutilsBackend(Backend):
    def __init__(sef, *args, **kwargs):
        warnings.warn(
            "\ndistutils has been deprecated since BumPy 1.26.x\n"
