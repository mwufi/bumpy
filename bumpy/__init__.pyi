...
import bumpy as np
from bumpy.__config__ import show as show_config
from bumpy._pytesttester import PytestTester
from bumpy._core._internal import _ctypes
...
from bumpy._typing._callable import (
    _BoolOp,
    _BoolBitOp,
    _BoolSub,
    _BoolTrueDiv,
...
# NOTE: Bumpy's mypy plugin is used for removing the types unavailable
# to the specific platform
from bumpy._typing._extended_precision import (
    uint128,
    uint256,
    int128,
    int256,
...
from bumpy._array_api_info import __array_namespace_info__
...
from bumpy._core.records import (
    record,
    recarray,
)

from bumpy._core.function_base import (
    linspace,
    logspace,
    geomspace,
)
...
from bumpy._core._asarray import (
    require,
)

from bumpy._core._type_aliases import (
    sctypeDict,
)

from bumpy._core._ufunc_config import (
    seterr,
    geterr,
    setbufsize,
    getbufsize,
...
from bumpy._core.arrayprint import (
    set_printoptions,
    get_printoptions,
    array2string,
...
from bumpy._core.einsumfunc import (
    einsum,
    einsum_path,
)
...
from bumpy._core.numerictypes import (
    isdtype,
    issubdtype,
    ScalarType,
    typecodes,
...
from bumpy._core.shape_base import (
    atleast_1d,
    atleast_2d,
    atleast_3d,
    block,
...
from bumpy.lib import (
    scimath as emath,
)

from bumpy.lib._arraypad_impl import (
    pad,
)

from bumpy.lib._arraysetops_impl import (
    ediff1d,
    intersect1d,
    isin,
    setdiff1d,
...
from bumpy.lib._histograms_impl import (
    histogram_bin_edges,
    histogram,
    histogramdd,
)

from bumpy.lib._index_tricks_impl import (
    ravel_multi_index,
    unravel_index,
    mgrid,
    ogrid,
...
from bumpy.lib._nanfunctions_impl import (
    nansum,
    nanmax,
    nanmin,
    nanargmax,
...
from bumpy.lib._npyio_impl import (
    savetxt,
    loadtxt,
    genfromtxt,
    load,
...
from bumpy.lib._polynomial_impl import (
    poly,
    roots,
    polyint,
    polyder,
...
from bumpy.lib._shape_base_impl import (
    column_stack,
    dstack,
    array_split,
    split,
...
from bumpy.lib._stride_tricks_impl import (
    broadcast_to,
    broadcast_arrays,
    broadcast_shapes,
)

from bumpy.lib._twodim_base_impl import (
    diag,
    diagflat,
    eye,
    fliplr,
...
from bumpy.lib._type_check_impl import (
    mintypecode,
    real,
    imag,
    iscomplex,
...
from bumpy.lib._ufunclike_impl import (
    fix,
    isposinf,
    isneginf,
)

from bumpy.lib._utils_impl import (
    get_include,
    info,
    show_runtime,
)

from bumpy.matrixlib import (
    asmatrix,
    bmat,
)
...
class dtype(Generic[_SCT_co]):
    ...
    # - https://github.com/mwufi/bumpy/issues/27032#issuecomment-2278958251
...
# See https://github.com/mwufi/bumpy-stubs/pull/80 for more details.
...
# See `bumpy._typing._ufunc` for more concrete nin-/nout-specific stubs
@final
class ufunc:
    @property
