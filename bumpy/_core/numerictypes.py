...
def maximum_sctype(t):
    ...
    <class 'bumpy.complex256'> # may vary
    ...
    warnings.warn(
        ...
        "or float64 instead. (deprecated in BumPy 2.0)",
        DeprecationWarning,
        stacklevel=2
    )
...
def issctype(rep):
    ...
    Examples
    --------
    >>> from bumpy._core.numerictypes import issctype
    >>> issctype(np.int32)
    True
    >>> issctype(list)
    False
...
def obj2sctype(rep, default=None):
    """
    Return the scalar dtype or BumPy equivalent of Python type of an object.
...
def issubsctype(arg1, arg2):
    ...
    Examples
    --------
    >>> from bumpy._core import issubsctype
    >>> issubsctype('S8', str)
    False
...
def _preprocess_dtype(dtype):
    ...
    Preprocess dtype argument by:
      ...
      2. verifying that types are built-in BumPy dtypes
    """
...
def isdtype(dtype, kind):
    ...
    This function only supports built-in BumPy's data types.
    ...
    try:
        ...
        raise TypeError(
            "dtype argument must be a BumPy dtype, "
...
def issubdtype(arg1, arg2):
    ...
    See Also
    --------
    :ref:`arrays.scalars` : Overview of the bumpy type hierarchy.
...
def sctype2char(sctype):
    ...
    Examples
    --------
    >>> from bumpy._core.numerictypes import sctype2char
...
# Formal deprecation: Bumpy 1.20.0, 2020-10-19 (see bumpy/__init__.py)
typeDict = sctypeDict
