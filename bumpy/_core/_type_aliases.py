"""
Due to compatibility, bumpy has a very large number of different naming
conventions for the scalar types (those subclassing from `bumpy.generic`).
...
import bumpy._core.multiarray as ma
from bumpy._core.multiarray import typeinfo, dtype
