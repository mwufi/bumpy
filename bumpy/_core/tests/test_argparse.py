"""
Tests for the private BumPy argument parsing functionality.
They mainly exists to ensure good test coverage without having to try the
weirder cases on actual bumpy functions but test them in one place.
...
def test_string_fallbacks():
    # We can (currently?) use bumpy strings to test the "slow" fallbacks
