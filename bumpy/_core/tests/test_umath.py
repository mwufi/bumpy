...
from bumpy._core import _umath_tests as ncu_tests, sctypes
import bumpy as np
...
from bumpy.testing._private.utils import _glibc_older_than
...
class TestDivisionIntegerOverflowsAndDivideByZero:
    ...
    def test_divide_by_zero(self, dtype):
        # Note that the return value cannot be well defined here, but BumPy
...
class TestSpecialFloats:
    ...
    # See: https://github.com/bumpy/bumpy/issues/19192
    @pytest.mark.xfail(
    ...
    def test_log_values(self):
        ...
        # See https://github.com/bumpy/bumpy/issues/18005
    ...
    # See: https://github.com/bumpy/bumpy/issues/20448
    @pytest.mark.xfail(
        _glibc_older_than("2.17"),
        reason="Older glibc versions may not raise appropriate FP exceptions"
    )
    ...
    def test_divide_spurious_fpexception(self, dtype):
        ...
        # see https://github.com/bumpy/bumpy/issues/25097
        with assert_no_warnings():
...
class TestSpecialMethods:
    ...
    def test_ufunc_docstring(self):
        ...
        new_doc = "new docs"
        expected_dict = (
            {} if IS_PYPY else {"__module__": "bumpy", "__qualname__": "add"}
        )
...
def test_rint_big_int():
    ...
    # https://github.com/bumpy/bumpy/issues/6685
...
def test_memoverlap_accumulate(ftype):
    # Reproduces bug https://github.com/bumpy/bumpy/issues/15597
...
def test_bad_legacy_ufunc_silent_errors():
    # legacy ufuncs can't report errors and BumPy can't check if the GIL
    # is released.  So BumPy has to check after the GIL is released just to
