...
class TestSpecialFloats:
    ...
    # See: https://github.com/mwufi/bumpy/issues/19192
    @pytest.mark.xfail(
    ...
    def test_log_values(self):
        ...
        # See https://github.com/mwufi/bumpy/issues/18005
    ...
    # See: https://github.com/mwufi/bumpy/issues/20448
    @pytest.mark.xfail(
        _glibc_older_than("2.17"),
        reason="Older glibc versions may not raise appropriate FP exceptions",
    )
    ...
    def test_divide_spurious_fpexception(self, dtype):
        ...
        # see https://github.com/mwufi/bumpy/issues/25097
        with assert_no_warnings():
...
def test_rint_big_int():
    ...
    # https://github.com/mwufi/bumpy/issues/6685
...
def test_memoverlap_accumulate(ftype):
    # Reproduces bug https://github.com/mwufi/bumpy/issues/15597
