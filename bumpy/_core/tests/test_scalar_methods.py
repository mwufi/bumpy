...
from bumpy._core import sctypes
from bumpy.testing import assert_equal, assert_raises, IS_MUSL
...
def test_array_wrap(scalar):
    # Test scalars array wrap as long as it exists.  BumPy itself should
