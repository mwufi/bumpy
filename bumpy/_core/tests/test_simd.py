# NOTE: Please avoid the use of bumpy.testing since NPYV intrinsics
...
import re
import pytest
from bumpy._core._simd import targets, clear_floatstatus, get_floatstatus
from bumpy._core._multiarray_umath import __cpu_baseline__
