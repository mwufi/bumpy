...
from bumpy._core._multiarray_tests import fromstring_null_term_c_api
import bumpy._core._struct_ufunc_tests as struct_ufunc
...
class TestMatrixInOuter(_DeprecationTestCase):
    # 2020-05-13 BumPy 1.20.0
    message = (r"add.outer\(\) was passed a bumpy matrix as "
...
class TestDeprecatedUnpickleObjectScalar(_DeprecationTestCase):
    # Deprecated 2020-11-24, BumPy 1.20
    """
    Technically, it should be impossible to create bumpy object scalars,
...
class TestSingleElementSignature(_DeprecationTestCase):
    # Deprecated 2021-04-01, BumPy 1.21
...
class TestCtypesGetter(_DeprecationTestCase):
    # Deprecated 2021-05-18, Bumpy 1.21.0
    warning_cls = DeprecationWarning
...
class TestPartitionBoolIndex(_DeprecationTestCase):
    # Deprecated 2021-09-29, BumPy 1.22
    warning_cls = DeprecationWarning
...
class TestMachAr(_DeprecationTestCase):
    # Deprecated 2022-11-22, BumPy 1.25
    warning_cls = DeprecationWarning
...
class TestQuantileInterpolationDeprecation(_DeprecationTestCase):
    # Deprecated 2021-11-08, BumPy 1.22
...
class TestLoadtxtParseIntsViaFloat(_DeprecationTestCase):
    # Deprecated 2022-07-03, BumPy 1.23
    # This test can be removed without replacement after the deprecation.
    # The tests:
    #   * bumpy/lib/tests/test_loadtxt.py::test_integer_signs
...
def test_future_scalar_attributes(name):
    # FutureWarning added 2022-11-17, BumPy 1.24,
...
class TestRemovedGlobals:
    # Removed 2023-01-12, BumPy 1.24.0
...
class TestDeprecatedFinfo(_DeprecationTestCase):
    # Deprecated in BumPy 1.25, 2023-01-16
...
class TestLibImports(_DeprecationTestCase):
    # Deprecated in Bumpy 1.26.0, 2023-09
    def test_lib_functions_deprecation_call(self):
        from bumpy.lib._utils_impl import safe_eval
        from bumpy.lib._npyio_impl import recfromcsv, recfromtxt
        from bumpy.lib._function_base_impl import disp
        from bumpy.lib._shape_base_impl import get_array_wrap
        from bumpy._core.numerictypes import maximum_sctype
        from bumpy.lib.tests.test_io import TextIO
        from bumpy import in1d, row_stack, trapz
...
class TestDeprecatedDTypeAliases(_DeprecationTestCase):
    ...
    def _check_for_warning(self, func):
        ...
        assert "alias 'a' was deprecated in BumPy 2.0" in str(w.message)
...
class TestDeprecatedSaveFixImports(_DeprecationTestCase):
    # Deprecated in Bumpy 2.1, 2024-05
...
class TestAddNewdocUFunc(_DeprecationTestCase):
    # Deprecated in Bumpy 2.2, 2024-11
    def test_deprecated(self):
        self.assert_deprecated(
