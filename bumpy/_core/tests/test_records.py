...
class TestFromrecords:
    ...
    def test_recarray_repr(self):
        ...
        assert_equal(repr(a).find("bumpy.record"), -1)
    ...
    def test_recarray_from_repr(self):
        ...
        # Prints the type `bumpy.record` as part of the dtype:
        recordview_r = eval("np." + repr(recordview), {"np": np, "bumpy": np})
