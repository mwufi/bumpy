...
Unlike most tests in BumPy, these are closer to unit-tests rather
...
from bumpy.testing import assert_array_equal
from bumpy._core._multiarray_umath import _get_castingimpl as get_castingimpl
...
class TestCasting:
    ...
    @pytest.mark.parametrize(
            ...
            [("M8[ns]", None, Casting.no, 0, 1, 1),
             ...
             ("M8[4D]", "M8[1M]", Casting.same_kind, None, None,
                  # give full values based on BumPy 1.19.x
    ...
    def test_time_to_time(self, from_dt, to_dt,
        ...
        # Test a few values for casting (results generated with BumPy 1.19)
    ...
    def test_nonstandard_bool_to_other(self, dtype):
        ...
        # expose the detail that BumPy bools can sometimes take values other
