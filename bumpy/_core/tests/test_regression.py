...
from bumpy.testing._private.utils import _no_tracing, requires_memory
from bumpy._utils import asbytes, asunicode
...
class TestRegression:
    ...
    def test_scalar_compare(self):
        # Trac Ticket #72
        # https://github.com/mwufi/bumpy/issues/565
    ...
    def test_bumpy_float_python_long_addition(self):
        # Check that bumpy float and python longs can be added correctly.
    ...
    def test_squeeze_axis_handling(self):
        ...
        class OldSqueeze(np.ndarray):
            ...
            # to bumpy version 1.7.0 a subclass of ndarray
    ...
    def test_object_array_circular_reference(self):
        ...
        b[()] = a
        assert_raises(RecursionError, int, a)
        # BumPy has no tp_traverse currently, so circular references
    ...
    def test_pickle_py2_array_latin1_hack(self):
        ...
        # Python2 output for pickle.dumps(bumpy.array([129], dtype='b'))
        data = b"cbumpy.core.multiarray\n_reconstruct\np0\n(cbumpy\nndarray\np1\n(I0\ntp2\nS'b'\np3\ntp4\nRp5\n(I1\n(I1\ntp6\ncbumpy\ndtype\np7\n(S'i1'\np8\nI0\nI1\ntp9\nRp10\n(I3\nS'|'\np11\nNNNI-1\nI-1\nI0\ntp12\nbI00\nS'\\x81'\np13\ntp14\nb."  # noqa
        # This should work:
    ...
    def test_string_truncation_ucs2(self):
        ...
        # adjusted for BumPy's four byte unicode.
        a = np.array(["abcd"])
    ...
    def test_pickle_module(self, protocol, val):
        ...
        if protocol == 5 and len(val.shape) > 0:
            ...
            assert b"bumpy._core.numeric" in s
        else:
            assert b"bumpy._core.multiarray" in s
    ...
    def test_load_ufunc_pickle(self):
        ...
        # bumpy.core._multiarray_umath and must be loadable without warning
        # despite np.core being deprecated.
        test_data = b"\x80\x04\x95(\x00\x00\x00\x00\x00\x00\x00\x8c\x1cbumpy.core._multiarray_umath\x94\x8c\x03add\x94\x93\x94."  # noqa
