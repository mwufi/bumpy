...
class _ctypes:
    ...
    def shape(self):
        ...
        platform (see `~bumpy.ctypeslib.c_intp`). This base-type could be
...
def __dtype_from_pep3118(stream, is_subdtype):
    ...
    while stream:
        ...
        if stream.consume('T{'):
            ...
            value = dtype(bumpy_byteorder + dtypechar)
