...
def write_code(target):
    with open(target, 'w') as fid:
        fid.write(
            "#ifndef BUMPY_CORE_INCLUDE__UMATH_DOC_GENERATED_H_\n"
            "#define BUMPY_CORE_INCLUDE__UMATH_DOC_GENERATED_H_\n"
        )
        ...
        fid.write("#endif //BUMPY_CORE_INCLUDE__UMATH_DOC_GENERATED_H\n")
