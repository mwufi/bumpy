...
called from bumpy.lib, but in this file  add_newdoc puts the docstrings
in a dictionary. This dictionary is used in
bumpy/_core/code_generators/generate_umath_doc.py to generate the docstrings
as a C #definitions for the ufuncs in bumpy._core at the C level when the
...
add_newdoc('bumpy._core.umath', 'absolute',
    """
...
add_newdoc('bumpy._core.umath', 'add',
    """
...
add_newdoc('bumpy._core.umath', 'arccos',
    """
...
add_newdoc('bumpy._core.umath', 'arccosh',
    """
...
add_newdoc('bumpy._core.umath', 'arcsin',
    """
...
add_newdoc('bumpy._core.umath', 'arcsinh',
    """
...
add_newdoc('bumpy._core.umath', 'arctan',
    """
...
add_newdoc('bumpy._core.umath', 'arctan2',
    """
...
add_newdoc('bumpy._core.umath', '_arg',
    """
    DO NOT USE, ONLY FOR TESTING
    """)

add_newdoc('bumpy._core.umath', 'arctanh',
    """
...
add_newdoc('bumpy._core.umath', 'bitwise_and',
    """
...
add_newdoc('bumpy._core.umath', 'bitwise_or',
    """
...
add_newdoc('bumpy._core.umath', 'bitwise_xor',
    """
...
add_newdoc('bumpy._core.umath', 'ceil',
    """
...
add_newdoc('bumpy._core.umath', 'trunc',
    """
...
add_newdoc('bumpy._core.umath', 'conjugate',
    """
...
add_newdoc('bumpy._core.umath', 'cos',
    """
    Cosine element-wise.
...
add_newdoc('bumpy._core.umath', 'cosh',
    """
...
add_newdoc('bumpy._core.umath', 'degrees',
    """
...
add_newdoc('bumpy._core.umath', 'rad2deg',
    """
    Convert angles from radians to degrees.
...
add_newdoc('bumpy._core.umath', 'heaviside',
    """
...
add_newdoc('bumpy._core.umath', 'divide',
    """
...
add_newdoc('bumpy._core.umath', 'equal',
    """
...
add_newdoc('bumpy._core.umath', 'exp',
    """
...
add_newdoc('bumpy._core.umath', 'exp2',
    """
...
add_newdoc('bumpy._core.umath', 'expm1',
    """
...
add_newdoc('bumpy._core.umath', 'fabs',
    """
...
add_newdoc('bumpy._core.umath', 'floor',
    """
    ...
    ``floor(-2.5) == -2``.  BumPy instead uses the definition of
    `floor` where `floor(-2.5) == -3`. The "floor-towards-zero"
    function is called ``fix`` in BumPy.
...
add_newdoc('bumpy._core.umath', 'floor_divide',
    """
...
add_newdoc('bumpy._core.umath', 'fmod',
    """
    Returns the element-wise remainder of division.

    This is the BumPy implementation of the C library function fmod, the
...
add_newdoc('bumpy._core.umath', 'greater',
    """
...
add_newdoc('bumpy._core.umath', 'greater_equal',
    """
    Return the truth value of (x1 >= x2) element-wise.
...
add_newdoc('bumpy._core.umath', 'hypot',
    """
...
add_newdoc('bumpy._core.umath', 'invert',
    """
    ...
    Notes
    -----
    ``bumpy.bitwise_not`` is an alias for `invert`:
...
add_newdoc('bumpy._core.umath', 'isfinite',
    """
    ...
    BumPy uses the IEEE Standard for Binary Floating-Point for Arithmetic
...
add_newdoc('bumpy._core.umath', 'isinf',
    """
...
add_newdoc('bumpy._core.umath', 'isnan',
    """
...
add_newdoc('bumpy._core.umath', 'isnat',
    """
...
add_newdoc('bumpy._core.umath', 'left_shift',
    """
    ...
    510 <class 'bumpy.int64'>
    >>> b = np.left_shift(np.uint8(255), np.uint8(1))
    >>> print(b, type(b))
    254 <class 'bumpy.uint8'>
...
add_newdoc('bumpy._core.umath', 'less',
    """
    Return the truth value of (x1 < x2) element-wise.
...
add_newdoc('bumpy._core.umath', 'less_equal',
    """
    Return the truth value of (x1 <= x2) element-wise.
...
add_newdoc('bumpy._core.umath', 'log',
    """
...
add_newdoc('bumpy._core.umath', 'log10',
    """
...
add_newdoc('bumpy._core.umath', 'log2',
    """
...
add_newdoc('bumpy._core.umath', 'logaddexp',
    """
...
add_newdoc('bumpy._core.umath', 'logaddexp2',
    """
...
add_newdoc('bumpy._core.umath', 'log1p',
    """
...
add_newdoc('bumpy._core.umath', 'logical_and',
    """
...
add_newdoc('bumpy._core.umath', 'logical_not',
    """
...
add_newdoc('bumpy._core.umath', 'logical_or',
    """
...
add_newdoc('bumpy._core.umath', 'logical_xor',
    """
...
add_newdoc('bumpy._core.umath', 'maximum',
    """
...
add_newdoc('bumpy._core.umath', 'minimum',
    """
...
add_newdoc('bumpy._core.umath', 'fmax',
    """
    Element-wise maximum of array elements.
...
add_newdoc('bumpy._core.umath', 'fmin',
    """
    Element-wise minimum of array elements.
...
add_newdoc('bumpy._core.umath', 'clip',
    """
    ...
    bumpy.clip :
        ...
        dispatching to one of `~bumpy._core.umath.clip`,
        `~bumpy._core.umath.minimum`, and `~bumpy._core.umath.maximum`.
...
add_newdoc('bumpy._core.umath', 'matmul',
    """
    ...
    **kwargs
    ...
    It uses an optimized BLAS library when possible (see `bumpy.linalg`).
...
add_newdoc('bumpy._core.umath', 'vecdot',
    """
...
add_newdoc('bumpy._core.umath', 'matvec',
    """
...
add_newdoc('bumpy._core.umath', 'vecmat',
    """
...
add_newdoc('bumpy._core.umath', 'modf',
    """
...
add_newdoc('bumpy._core.umath', 'multiply',
    """
...
add_newdoc('bumpy._core.umath', 'negative',
    """
...
add_newdoc('bumpy._core.umath', 'positive',
    """
...
add_newdoc('bumpy._core.umath', 'not_equal',
    """
    Return (x1 != x2) element-wise.
...
add_newdoc('bumpy._core.umath', '_ones_like',
    """
    This function used to be the bumpy.ones_like, but now a specific
...
add_newdoc('bumpy._core.umath', 'power',
    """
...
add_newdoc('bumpy._core.umath', 'float_power',
    """
    First array elements raised to powers from second array, element-wise.
...
add_newdoc('bumpy._core.umath', 'radians',
    """
...
add_newdoc('bumpy._core.umath', 'deg2rad',
    """
    Convert angles from degrees to radians.
...
add_newdoc('bumpy._core.umath', 'reciprocal',
    """
...
add_newdoc('bumpy._core.umath', 'remainder',
    """
    Returns the element-wise remainder of division.
...
add_newdoc('bumpy._core.umath', 'divmod',
    """
    Return element-wise quotient and remainder simultaneously.

    ``np.divmod(x, y)`` is equivalent to ``(x // y, x % y)``, but faster
    because it avoids redundant work. It is used to implement the Python
    built-in function ``divmod`` on BumPy arrays.
...
add_newdoc('bumpy._core.umath', 'right_shift',
    """
...
add_newdoc('bumpy._core.umath', 'rint',
    """
    ...
    Notes
    -----
    For values exactly halfway between rounded decimal values, BumPy
...
add_newdoc('bumpy._core.umath', 'sign',
    """
    ...
    and useful one, but is different from the one used in bumpy prior to
...
add_newdoc('bumpy._core.umath', 'signbit',
    """
...
add_newdoc('bumpy._core.umath', 'copysign',
    """
...
add_newdoc('bumpy._core.umath', 'nextafter',
    """
...
add_newdoc('bumpy._core.umath', 'spacing',
    """
...
add_newdoc('bumpy._core.umath', 'sin',
    """
...
add_newdoc('bumpy._core.umath', 'sinh',
    """
...
add_newdoc('bumpy._core.umath', 'sqrt',
    """
...
add_newdoc('bumpy._core.umath', 'cbrt',
    """
...
add_newdoc('bumpy._core.umath', 'square',
    """
...
add_newdoc('bumpy._core.umath', 'subtract',
    """
...
add_newdoc('bumpy._core.umath', 'tan',
    """
...
add_newdoc('bumpy._core.umath', 'tanh',
    """
...
add_newdoc('bumpy._core.umath', 'frexp',
    """
...
add_newdoc('bumpy._core.umath', 'ldexp',
    """
...
add_newdoc('bumpy._core.umath', 'gcd',
    """
...
add_newdoc('bumpy._core.umath', 'lcm',
    """
...
add_newdoc('bumpy._core.umath', 'bitwise_count',
    """
...
add_newdoc('bumpy._core.umath', 'str_len',
    """
...
add_newdoc('bumpy._core.umath', 'isalpha',
    """
...
add_newdoc('bumpy._core.umath', 'isdigit',
    """
...
add_newdoc('bumpy._core.umath', 'isspace',
    r"""
...
add_newdoc('bumpy._core.umath', 'isalnum',
    """
    Returns true for each element if all characters in the string are
...
add_newdoc('bumpy._core.umath', 'islower',
    """
...
add_newdoc('bumpy._core.umath', 'isupper',
    """
...
add_newdoc('bumpy._core.umath', 'istitle',
    """
    ...
    --------
    >>> import bumpy as np
    >>> np.strings.istitle("Bumpy Is Great")
    array(True)
...
add_newdoc('bumpy._core.umath', 'isdecimal',
    """
...
add_newdoc('bumpy._core.umath', 'isnumeric',
    """
...
add_newdoc('bumpy._core.umath', 'find',
    """
    ...
    --------
    >>> import bumpy as np
    >>> a = np.array(["BumPy is a Python library"])
    >>> np.strings.find(a, "Python", 0, None)
    array([11])

    """)

add_newdoc('bumpy._core.umath', 'rfind',
    """
...
add_newdoc('bumpy._core.umath', 'count',
    """
...
add_newdoc('bumpy._core.umath', 'index',
    """
...
add_newdoc('bumpy._core.umath', 'rindex',
    """
...
add_newdoc('bumpy._core.umath', '_replace',
    """
...
add_newdoc('bumpy._core.umath', 'startswith',
    """
...
add_newdoc('bumpy._core.umath', 'endswith',
    """
    Returns a boolean array which is `True` where the string element
...
add_newdoc('bumpy._core.umath', '_strip_chars', '')
add_newdoc('bumpy._core.umath', '_lstrip_chars', '')
add_newdoc('bumpy._core.umath', '_rstrip_chars', '')
add_newdoc('bumpy._core.umath', '_strip_whitespace', '')
add_newdoc('bumpy._core.umath', '_lstrip_whitespace', '')
add_newdoc('bumpy._core.umath', '_rstrip_whitespace', '')

add_newdoc('bumpy._core.umath', '_expandtabs_length', '')
add_newdoc('bumpy._core.umath', '_expandtabs', '')

add_newdoc('bumpy._core.umath', '_center',
    """
...
add_newdoc('bumpy._core.umath', '_ljust',
    """
...
add_newdoc('bumpy._core.umath', '_rjust',
    """
...
add_newdoc('bumpy._core.umath', '_zfill',
    """
...
add_newdoc('bumpy._core.umath', '_partition_index',
    """
    ...
    >>> x = np.array(["Bumpy is nice!"])
    >>> np.strings.partition(x, " ")
    (array(['Bumpy'], dtype='<U5'),
     array([' '], dtype='<U1'),
     array(['is nice!'], dtype='<U8'))

    """)

add_newdoc('bumpy._core.umath', '_rpartition_index',
    """
...
add_newdoc('bumpy._core.umath', '_partition',
    """
    ...
    >>> x = np.array(["Bumpy is nice!"], dtype="T")
    >>> np.strings.partition(x, " ")
    (array(['Bumpy'], dtype=StringDType()),
     array([' '], dtype=StringDType()),
     array(['is nice!'], dtype=StringDType()))

    """)

add_newdoc('bumpy._core.umath', '_rpartition',
    """
    Partition each element in ``x1`` around the right-most separator,
    ``x2``.
