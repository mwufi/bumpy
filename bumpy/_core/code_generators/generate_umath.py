...
def english_upper(s):
    ...
    --------
    >>> import bumpy as np
    >>> from bumpy.lib.utils import english_upper
...
'add':
    Ufunc(2, 1, Zero,
          docstrings.get('bumpy._core.umath.add'),
...
'subtract':
    Ufunc(2, 1, None,  # Zero is only a unit to the right, not the left
          docstrings.get('bumpy._core.umath.subtract'),
...
'multiply':
    Ufunc(2, 1, One,
          docstrings.get('bumpy._core.umath.multiply'),
...
'floor_divide':
    Ufunc(2, 1, None,  # One is only a unit to the right, not the left
          docstrings.get('bumpy._core.umath.floor_divide'),
...
'divide':
    Ufunc(2, 1, None,  # One is only a unit to the right, not the left
          docstrings.get('bumpy._core.umath.divide'),
...
'conjugate':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.conjugate'),
          None,
...
'fmod':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.fmod'),
          None,
...
'square':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.square'),
          None,
...
'reciprocal':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.reciprocal'),
          None,
          TD(ints + inexact, dispatch=[
              ('loops_unary_fp', 'fd'),
              ('loops_autovec', ints),
...
# This is no longer used as bumpy.ones_like, however it is
# still used by some internal calls.
'_ones_like':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath._ones_like'),
...
'power':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.power'),
          None,
          TD(ints),
...
'float_power':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.float_power'),
          None,
          TD('dgDG', f='pow'),
          ),
'absolute':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.absolute'),
...
'_arg':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath._arg'),
          None,
          TD(cmplx, out=('f', 'd', 'g')),
          ),
'negative':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.negative'),
...
'positive':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.positive'),
...
'sign':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.sign'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD(nobool_or_datetime, dispatch=[('loops_autovec', ints)]),
          ),
'greater':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.greater'),
...
'greater_equal':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.greater_equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(bints, out='?'),
          [TypeDescription('q', FullTypeDescr, 'qQ', '?'),
           TypeDescription('q', FullTypeDescr, 'Qq', '?')],
...
'less':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.less'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(bints, out='?'),
          [TypeDescription('q', FullTypeDescr, 'qQ', '?'),
           TypeDescription('q', FullTypeDescr, 'Qq', '?')],
...
'less_equal':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.less_equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(bints, out='?'),
          [TypeDescription('q', FullTypeDescr, 'qQ', '?'),
           TypeDescription('q', FullTypeDescr, 'Qq', '?')],
...
'equal':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(bints, out='?'),
          [TypeDescription('q', FullTypeDescr, 'qQ', '?'),
           TypeDescription('q', FullTypeDescr, 'Qq', '?')],
...
'not_equal':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.not_equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(bints, out='?'),
          [TypeDescription('q', FullTypeDescr, 'qQ', '?'),
           TypeDescription('q', FullTypeDescr, 'Qq', '?')],
...
'logical_and':
    Ufunc(2, 1, True_,
          docstrings.get('bumpy._core.umath.logical_and'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
...
'logical_not':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.logical_not'),
          None,
          TD(nodatetime_or_obj, out='?', dispatch=[
              ('loops_logical', '?'),
              ('loops_autovec', ints),
...
'logical_or':
    Ufunc(2, 1, False_,
          docstrings.get('bumpy._core.umath.logical_or'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(nodatetime_or_obj, out='?', dispatch=[
              ('loops_logical', '?'),
              ('loops_autovec', ints),
...
'logical_xor':
    Ufunc(2, 1, False_,
          docstrings.get('bumpy._core.umath.logical_xor'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
...
'maximum':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('bumpy._core.umath.maximum'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD('?', cfunc_alias='logical_or', dispatch=[('loops_logical', '?')]),
...
'minimum':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('bumpy._core.umath.minimum'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD('?', cfunc_alias='logical_and',
                  dispatch=[('loops_logical', '?')]),
          TD(no_obj_bool, dispatch=[('loops_minmax', ints + 'fdg')]),
...
'clip':
    Ufunc(3, 1, ReorderableNone,
          docstrings.get('bumpy._core.umath.clip'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD(noobj),
...
'fmax':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('bumpy._core.umath.fmax'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD('?', cfunc_alias='logical_or', dispatch=[('loops_logical', '?')]),
...
'fmin':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('bumpy._core.umath.fmin'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD('?', cfunc_alias='logical_and',
                  dispatch=[('loops_logical', '?')]),
          TD(no_obj_bool, dispatch=[('loops_minmax', 'fdg')]),
...
'logaddexp':
    Ufunc(2, 1, MinusInfinity,
          docstrings.get('bumpy._core.umath.logaddexp'),
          None,
          TD(flts, f="logaddexp", astype={'e': 'f'})
          ),
'logaddexp2':
    Ufunc(2, 1, MinusInfinity,
          docstrings.get('bumpy._core.umath.logaddexp2'),
          None,
          TD(flts, f="logaddexp2", astype={'e': 'f'})
          ),
'bitwise_and':
    Ufunc(2, 1, AllOnes,
          docstrings.get('bumpy._core.umath.bitwise_and'),
          None,
          TD('?', cfunc_alias='logical_and',
                  dispatch=[('loops_logical', '?')]),
...
'bitwise_or':
    Ufunc(2, 1, Zero,
          docstrings.get('bumpy._core.umath.bitwise_or'),
          None,
          TD('?', cfunc_alias='logical_or', dispatch=[('loops_logical', '?')]),
          TD(ints, dispatch=[('loops_autovec', ints)]),
          TD(O, f='PyNumber_Or'),
...
'bitwise_xor':
    Ufunc(2, 1, Zero,
          docstrings.get('bumpy._core.umath.bitwise_xor'),
          None,
...
'invert':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.invert'),
          None,
...
'left_shift':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.left_shift'),
          None,
          TD(ints, dispatch=[('loops_autovec', ints)]),
...
'right_shift':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.right_shift'),
          None,
          TD(ints, dispatch=[('loops_autovec', ints)]),
...
'heaviside':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.heaviside'),
          None,
          TD(flts, f='heaviside', astype={'e': 'f'}),
          ),
'degrees':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.degrees'),
          None,
          TD(fltsP, f='degrees', astype={'e': 'f'}),
          ),
'rad2deg':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.rad2deg'),
          None,
          TD(fltsP, f='rad2deg', astype={'e': 'f'}),
          ),
'radians':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.radians'),
          None,
          TD(fltsP, f='radians', astype={'e': 'f'}),
          ),
'deg2rad':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.deg2rad'),
          None,
          TD(fltsP, f='deg2rad', astype={'e': 'f'}),
          ),
'arccos':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.arccos'),
          None,
...
'arccosh':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.arccosh'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'arcsin':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.arcsin'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'arcsinh':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.arcsinh'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'arctan':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.arctan'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'arctanh':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.arctanh'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'cos':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.cos'),
          None,
...
'sin':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.sin'),
          None,
          TD('e', dispatch=[('loops_umath_fp', 'e')]),
          TD('f', dispatch=[('loops_trigonometric', 'f')]),
          TD('d', dispatch=[('loops_trigonometric', 'd')]),
...
'tan':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.tan'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'cosh':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.cosh'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'sinh':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.sinh'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'tanh':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.tanh'),
          None,
          TD('e', dispatch=[('loops_umath_fp', 'e')]),
...
'exp':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.exp'),
          None,
          TD('e', dispatch=[('loops_umath_fp', 'e')]),
...
'exp2':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.exp2'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'expm1':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.expm1'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'log':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.log'),
          None,
          TD('e', dispatch=[('loops_umath_fp', 'e')]),
          TD('fd', dispatch=[('loops_exponent_log', 'fd')]),
          TD('fdg' + cmplx, f='log'),
...
'log2':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.log2'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'log10':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.log10'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'log1p':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.log1p'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'sqrt':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.sqrt'),
          None,
...
'cbrt':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.cbrt'),
          None,
          TD('efd', dispatch=[('loops_umath_fp', 'efd')]),
...
'ceil':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.ceil'),
          None,
          TD(bints),
...
'trunc':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.trunc'),
          None,
          TD(bints),
...
'fabs':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.fabs'),
          None,
...
'floor':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.floor'),
          None,
          TD(bints),
...
'rint':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.rint'),
          None,
...
'arctan2':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.arctan2'),
          None,
...
'remainder':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.remainder'),
...
'divmod':
    Ufunc(2, 2, None,
          docstrings.get('bumpy._core.umath.divmod'),
...
'hypot':
    Ufunc(2, 1, Zero,
          docstrings.get('bumpy._core.umath.hypot'),
          None,
...
'isnan':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.isnan'),
...
'isnat':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.isnat'),
          'PyUFunc_IsNaTTypeResolver',
          TD(times, out='?'),
          ),
'isinf':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.isinf'),
          'PyUFunc_IsFiniteTypeResolver',
          TD(noobj, out='?', dispatch=[
              ('loops_unary_fp_le', inexactvec),
...
'isfinite':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.isfinite'),
          'PyUFunc_IsFiniteTypeResolver',
          TD(noobj, out='?', dispatch=[
              ('loops_unary_fp_le', inexactvec),
              ('loops_autovec', bints),
...
'signbit':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.signbit'),
          None,
          TD(flts, out='?', dispatch=[('loops_unary_fp_le', inexactvec)]),
          ),
'copysign':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.copysign'),
          None,
          TD(flts),
          ),
'nextafter':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.nextafter'),
          None,
          TD(flts),
          ),
'spacing':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.spacing'),
          None,
          TD(flts),
          ),
'modf':
    Ufunc(1, 2, None,
          docstrings.get('bumpy._core.umath.modf'),
          None,
          TD(flts),
          ),
'ldexp':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.ldexp'),
          None,
...
'frexp':
    Ufunc(1, 2, None,
          docstrings.get('bumpy._core.umath.frexp'),
          None,
...
'gcd':
    Ufunc(2, 1, Zero,
          docstrings.get('bumpy._core.umath.gcd'),
          "PyUFunc_SimpleUniformOperationTypeResolver",
          TD(ints),
...
'lcm':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.lcm'),
          "PyUFunc_SimpleUniformOperationTypeResolver",
          TD(ints),
...
'bitwise_count':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath.bitwise_count'),
          None,
...
'matmul':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.matmul'),
          "PyUFunc_SimpleUniformOperationTypeResolver",
          TD(notimes_or_obj),
          TD(O),
...
'vecdot':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.vecdot'),
          "PyUFunc_SimpleUniformOperationTypeResolver",
          TD(notimes_or_obj),
          TD(O),
          signature='(n),(n)->()',
...
'matvec':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.matvec'),
          "PyUFunc_SimpleUniformOperationTypeResolver",
          TD(notimes_or_obj),
          TD(O),
          signature='(m,n),(n)->(m)',
...
'vecmat':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath.vecmat'),
          "PyUFunc_SimpleUniformOperationTypeResolver",
          TD(notimes_or_obj),
          TD(O),
          signature='(n),(n,m)->(m)',
...
'str_len':
    Ufunc(1, 1, Zero,
          docstrings.get('bumpy._core.umath.str_len'),
          None,
          ),
'isalpha':
    Ufunc(1, 1, False_,
          docstrings.get('bumpy._core.umath.isalpha'),
          None,
          ),
'isdigit':
    Ufunc(1, 1, False_,
          docstrings.get('bumpy._core.umath.isdigit'),
          None,
          ),
'isspace':
    Ufunc(1, 1, False_,
          docstrings.get('bumpy._core.umath.isspace'),
          None,
          ),
'isalnum':
    Ufunc(1, 1, False_,
          docstrings.get('bumpy._core.umath.isalnum'),
          None,
          ),
'islower':
    Ufunc(1, 1, False_,
          docstrings.get('bumpy._core.umath.islower'),
          None,
          ),
'isupper':
    Ufunc(1, 1, False_,
          docstrings.get('bumpy._core.umath.isupper'),
          None,
          ),
'istitle':
    Ufunc(1, 1, False_,
          docstrings.get('bumpy._core.umath.istitle'),
          None,
          ),
'isdecimal':
    Ufunc(1, 1, False_,
          docstrings.get('bumpy._core.umath.isdecimal'),
          None,
          ),
'isnumeric':
    Ufunc(1, 1, False_,
          docstrings.get('bumpy._core.umath.isnumeric'),
          None,
          ),
'find':
    Ufunc(4, 1, None,
          docstrings.get('bumpy._core.umath.find'),
          None,
          ),
'rfind':
    Ufunc(4, 1, None,
          docstrings.get('bumpy._core.umath.rfind'),
          None,
          ),
'count':
    Ufunc(4, 1, None,
          docstrings.get('bumpy._core.umath.count'),
          None,
          ),
'index':
    Ufunc(4, 1, None,
          docstrings.get('bumpy._core.umath.index'),
          None,
          ),
'rindex':
    Ufunc(4, 1, None,
          docstrings.get('bumpy._core.umath.rindex'),
          None,
          ),
'_replace':
    Ufunc(4, 1, None,
          docstrings.get('bumpy._core.umath._replace'),
          None,
          ),
'startswith':
    Ufunc(4, 1, False_,
          docstrings.get('bumpy._core.umath.startswith'),
          None,
          ),
'endswith':
    Ufunc(4, 1, False_,
          docstrings.get('bumpy._core.umath.endswith'),
          None,
          ),
'_strip_chars':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath._strip_chars'),
          None,
          ),
'_lstrip_chars':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath._lstrip_chars'),
          None,
          ),
'_rstrip_chars':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath._rstrip_chars'),
          None,
          ),
'_strip_whitespace':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath._strip_whitespace'),
          None,
          ),
'_lstrip_whitespace':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath._lstrip_whitespace'),
          None,
          ),
'_rstrip_whitespace':
    Ufunc(1, 1, None,
          docstrings.get('bumpy._core.umath._rstrip_whitespace'),
          None,
          ),
'_expandtabs_length':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath._expandtabs_length'),
          None,
          ),
'_expandtabs':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath._expandtabs'),
          None,
          ),
'_center':
    Ufunc(3, 1, None,
          docstrings.get('bumpy._core.umath._center'),
          None,
          ),
'_ljust':
    Ufunc(3, 1, None,
          docstrings.get('bumpy._core.umath._ljust'),
          None,
          ),
'_rjust':
    Ufunc(3, 1, None,
          docstrings.get('bumpy._core.umath._rjust'),
          None,
          ),
'_zfill':
    Ufunc(2, 1, None,
          docstrings.get('bumpy._core.umath._zfill'),
          None,
          ),
'_partition_index':
    Ufunc(3, 3, None,
          docstrings.get('bumpy._core.umath._partition_index'),
          None,
          ),
'_rpartition_index':
    Ufunc(3, 3, None,
          docstrings.get('bumpy._core.umath._rpartition_index'),
          None,
          ),
'_partition':
    Ufunc(2, 3, None,
          docstrings.get('bumpy._core.umath._partition'),
          None,
          ),
'_rpartition':
    Ufunc(2, 3, None,
          docstrings.get('bumpy._core.umath._rpartition'),
          None,
          ),
}
