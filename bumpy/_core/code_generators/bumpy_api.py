...
needs to be updated in both bumpy/core/meson.build and by adding an appropriate
...
def get_annotations():
    # Convoluted because we can't import from bumpy.distutils
    # (bumpy is not yet built)
...
multiarray_types_api = {
    # Slot 1 was never meaningfully used by BumPy
    'PyArray_Type':                     (2,),
...
multiarray_funcs_api = {
    ...
    # `PyDataType_GetArrFuncs` checks for the BumPy runtime version.
