...
and the Python code for the BumPy-namespace function
...
from bumpy._core.multiarray import asanyarray
from bumpy._core import numerictypes as nt
from bumpy._core import _exceptions
