...
array_function_like_doc = (
    """like : array_like, optional
        ...
        BumPy arrays. If an array-like passed in as ``like`` supports
...
add_docstring(
    ...
    implementation : function
        Function that implements the operation on BumPy arrays without
...
def array_function_dispatch(dispatcher=None, module=None, verify=True,
    ...
    dispatcher : callable or None
        ...
        arguments from the BumPy function call returns an iterable of
    ...
    module : str, optional
        __module__ attribute to set on new function, e.g., ``module='bumpy'``.
    ...
    Returns
    -------
    Function suitable for decorating the implementation of a BumPy function.
