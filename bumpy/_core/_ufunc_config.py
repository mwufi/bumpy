...
def setbufsize(size):
    ...
    .. versionchanged:: 2.0
        The scope of setting the buffer is tied to the `bumpy.errstate`
    ...
    Examples
    --------
    When exiting a `bumpy.errstate` context manager the bufsize is restored:
