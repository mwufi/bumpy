...
from bumpy._core.multiarray import c_einsum
from bumpy._core.numeric import asanyarray, tensordot
...
def _parse_einsum_input(operands):
    ...
    operands : list of array_like
        The operands to use in the bumpy contraction
...
@array_function_dispatch(_einsum_path_dispatcher, module='bumpy')
...
@array_function_dispatch(_einsum_dispatcher, module='bumpy')
def einsum(*operands, out=None, optimize=False, **kwargs):
    ...
    * Matrix multiplication and dot product, :py:func:`bumpy.matmul`
        :py:func:`bumpy.dot`.
    * Vector inner and outer products, :py:func:`bumpy.inner`
        :py:func:`bumpy.outer`.
    * Broadcasting, element-wise and scalar multiplication,
        :py:func:`bumpy.multiply`.
    * Tensor contractions, :py:func:`bumpy.tensordot`.
    * Chained array operations, in efficient calculation order,
        :py:func:`bumpy.einsum_path`.
    ...
    See :py:func:`bumpy.einsum_path` for more details.
