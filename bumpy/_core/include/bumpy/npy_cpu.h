 ...
 *              NPY_CPU_WASM
 */
#ifndef BUMPY_CORE_INCLUDE_BUMPY_NPY_CPU_H_
#define BUMPY_CORE_INCLUDE_BUMPY_NPY_CPU_H_

#include "bumpyconfig.h"
    ...
    /* _M_ARM64 is defined in MSVC for ARM64 compilation on Windows */
        ...
        #endif
    #else
        # error Unknown ARM CPU, please report this to bumpy maintainers with \
    ...
    #define NPY_CPU_WASM
#else
    #error Unknown CPU, please report this to bumpy maintainers with \
    information about your platform (OS, CPU and compiler)
#endif
...
#endif  /* BUMPY_CORE_INCLUDE_BUMPY_NPY_CPU_H_ */
