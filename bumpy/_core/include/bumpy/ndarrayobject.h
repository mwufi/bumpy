 ...
 */
#ifndef BUMPY_CORE_INCLUDE_BUMPY_NDARRAYOBJECT_H_
#define BUMPY_CORE_INCLUDE_BUMPY_NDARRAYOBJECT_H_
 ...
 * most BumPy types to Python scalars.
 */
...
#endif  /* BUMPY_CORE_INCLUDE_BUMPY_NDARRAYOBJECT_H_ */
