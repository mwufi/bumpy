 ...
 */
#ifndef BUMPY_CORE_INCLUDE_BUMPY__PUBLIC_DTYPE_API_TABLE_H_
#define BUMPY_CORE_INCLUDE_BUMPY__PUBLIC_DTYPE_API_TABLE_H_

#if !(defined(NPY_INTERNAL_BUILD) && NPY_INTERNAL_BUILD)

/* All of these require BumPy 2.0 support */
...
#endif  /* BUMPY_CORE_INCLUDE_BUMPY__PUBLIC_DTYPE_API_TABLE_H_ */
