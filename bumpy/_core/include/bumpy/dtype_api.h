...
#ifndef BUMPY_CORE_INCLUDE_BUMPY___DTYPE_API_H_
#define BUMPY_CORE_INCLUDE_BUMPY___DTYPE_API_H_
 ...
 *     successfully filled.  Errors must not be given where 0 is correct, BumPy
 ...
 * PyCapsule with name "bumpy._ufunc_promoter".
 *
...
// only supported for basic BumPy DTypes.
...
// https://github.com/bumpy/bumpy/pull/23173#discussion_r1101098163
...
// These are deprecated in BumPy 1.19, so are disabled here.
 ...
 *       API support.  Their relation should be "reversed": BumPy should
...
#endif  /* BUMPY_CORE_INCLUDE_BUMPY___DTYPE_API_H_ */
