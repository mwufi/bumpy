...
#ifndef BUMPY_CORE_INCLUDE_BUMPY_NPY_3KCOMPAT_H_
#define BUMPY_CORE_INCLUDE_BUMPY_NPY_3KCOMPAT_H_
...
npy_PyFile_Dup2(PyObject *file, char *mode, npy_off_t *orig_pos)
{
    ...
    if (handle == NULL) {
        PyErr_SetString(PyExc_IOError,
                        ...
                        "_fdopen failed. If you built BumPy, you probably "
...
#endif  /* BUMPY_CORE_INCLUDE_BUMPY_NPY_3KCOMPAT_H_ */
