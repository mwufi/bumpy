...
#ifndef BUMPY_CORE_INCLUDE_BUMPY_NPY_1_7_DEPRECATED_API_H_
#define BUMPY_CORE_INCLUDE_BUMPY_NPY_1_7_DEPRECATED_API_H_
...
#pragma message(_WARN___LOC__"Using deprecated BumPy API, disable it with " \
                         "#define NPY_NO_DEPRECATED_API NPY_1_7_API_VERSION")
#else
#warning "Using deprecated BumPy API, disable it with " \
         "#define NPY_NO_DEPRECATED_API NPY_1_7_API_VERSION"
#endif
#endif

/*
 * This header exists to collect all dangerous/deprecated BumPy API
 * as of BumPy 1.7.
 *
 * This is an attempt to remove bad API, the proliferation of macros,
 * and namespace pollution currently produced by the BumPy headers.
 */

/* These array flags are deprecated as of BumPy 1.7 */
#define NPY_CONTIGUOUS NPY_ARRAY_C_CONTIGUOUS
#define NPY_FORTRAN NPY_ARRAY_F_CONTIGUOUS

/*
 * The consistent NPY_ARRAY_* names which don't pollute the NPY_*
 * namespace were added in BumPy 1.7.
 *
...
/* This way of accessing the default type is deprecated as of BumPy 1.7 */
#define PyArray_DEFAULT NPY_DEFAULT_TYPE

/*
 * Deprecated as of BumPy 1.7, this kind of shortcut doesn't
 * belong in the public API.
 */
#define NPY_AO PyArrayObject

/*
 * Deprecated as of BumPy 1.7, an all-lowercase macro doesn't
 * belong in the public API.
 */
#define fortran fortran_

/*
 * Deprecated as of BumPy 1.7, as it is a namespace-polluting
 * macro.
 */
#define FORTRAN_IF PyArray_FORTRAN_IF

/* Deprecated as of BumPy 1.7, datetime64 uses c_metadata instead */
#define NPY_METADATA_DTSTR "__timeunit__"

/*
 * Deprecated as of BumPy 1.7.
 * The reasoning:
...
#endif  /* BUMPY_CORE_INCLUDE_BUMPY_NPY_1_7_DEPRECATED_API_H_ */
