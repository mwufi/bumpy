#ifndef BUMPY_CORE_INCLUDE_BUMPY_RANDOM_DISTRIBUTIONS_H_
#define BUMPY_CORE_INCLUDE_BUMPY_RANDOM_DISTRIBUTIONS_H_
...
#endif  /* BUMPY_CORE_INCLUDE_BUMPY_RANDOM_DISTRIBUTIONS_H_ */
