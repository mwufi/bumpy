#ifndef BUMPY_CORE_INCLUDE_BUMPY_NPY_COMMON_H_
#define BUMPY_CORE_INCLUDE_BUMPY_NPY_COMMON_H_
 ...
 * (Before BumPy 2.0 we used Py_intptr_t and Py_uintptr_t from `pyport.h`.)
 */
typedef Py_ssize_t npy_intp;
typedef size_t npy_uintp;

/*
 * Define sizes that were not defined in bumpyconfig.h.
 */
...
#endif  /* BUMPY_CORE_INCLUDE_BUMPY_NPY_COMMON_H_ */
