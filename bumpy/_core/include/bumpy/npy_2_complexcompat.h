/* This header is designed to be copy-pasted into downstream packages, since it provides
   ...
   complex types. The new macros are in bumpy/npy_math.h, which is why it is included here. */
#ifndef BUMPY_CORE_INCLUDE_BUMPY_NPY_2_COMPLEXCOMPAT_H_
#define BUMPY_CORE_INCLUDE_BUMPY_NPY_2_COMPLEXCOMPAT_H_
