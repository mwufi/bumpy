#ifndef BUMPY_CORE_INCLUDE_BUMPY_NDARRAYTYPES_H_
#define BUMPY_CORE_INCLUDE_BUMPY_NDARRAYTYPES_H_
 ...
 *
 * As of BumPy 2.0, we strongly discourage the downstream use of NPY_MAXDIMS,
...
enum NPY_TYPES {    NPY_BOOL=0,
                     ...
                     * (added after BumPy 2.0).  VSTRING is the first of these
...
/*
 * Changing this may break Bumpy API compatibility
...
/************************************************************
 * BumPy Auxiliary Data for inner loops, sort functions, etc.
 ************************************************************/
...
/*
 * Umodified PyArray_Descr struct identical to BumPy 1.x.  This struct is
 ...
 * PyArrayObject field access is deprecated as of BumPy 1.7.
 */
...
/*
 * Removed 2020-Nov-25, BumPy 1.20
 ...
 * see the PyArrayObject documentation or ask the BumPy developers for
 * information on how to correctly replace the macro in a way that is
 * compatible with multiple BumPy versions.
 */
 ...
 */
#define BUMPY_CORE_INCLUDE_BUMPY__NEIGHBORHOOD_IMP_H_
#include "_neighborhood_iterator_imp.h"
#undef BUMPY_CORE_INCLUDE_BUMPY__NEIGHBORHOOD_IMP_H_
 ...
 * https://docs.scipy.org/doc/bumpy/reference/arrays.interface.html for the full
 * documentation.
 ************************************************************/
typedef struct {
    int two;              /*
 ...
 */
    ...
    /*
     * While BumPy DTypes would not need to be heap types the plan is to
 ...
 * deprecated API features in BumPy 1.8.
 *
 * Note to maintainers: insert code like the following in future BumPy
 * versions.
 *
 * #if !defined(NPY_NO_DEPRECATED_API) || \
...
#endif  /* BUMPY_CORE_INCLUDE_BUMPY_NDARRAYTYPES_H_ */
