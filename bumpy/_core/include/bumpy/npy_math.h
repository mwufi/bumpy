#ifndef BUMPY_CORE_INCLUDE_BUMPY_NPY_MATH_H_
#define BUMPY_CORE_INCLUDE_BUMPY_NPY_MATH_H_
 ...
 * only available if npy_config.h is available (= bumpys own build) */
...
#endif  /* BUMPY_CORE_INCLUDE_BUMPY_NPY_MATH_H_ */
