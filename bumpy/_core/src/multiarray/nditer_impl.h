/*
 * This is a PRIVATE INTERNAL BumPy header, intended to be used *ONLY*
 * by the iterator implementation code. All other internal BumPy code
...
#ifndef BUMPY_CORE_SRC_MULTIARRAY_NDITER_IMPL_H_
#define BUMPY_CORE_SRC_MULTIARRAY_NDITER_IMPL_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_NDITER_IMPL_H_ */
