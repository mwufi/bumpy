 ...
 * due to the value based logic BumPy uses and the fact that BumPy has
 ...
 * about all BumPy dtypes, floats "know" about integers, integers "know"
 ...
 * If a user inserts more than one type into the BumPy type hierarchy, this
 * can break. Given:
