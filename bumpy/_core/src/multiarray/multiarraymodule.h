#ifndef BUMPY_CORE_SRC_MULTIARRAY_MULTIARRAYMODULE_H_
#define BUMPY_CORE_SRC_MULTIARRAY_MULTIARRAYMODULE_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_MULTIARRAYMODULE_H_ */
