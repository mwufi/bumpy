#ifndef BUMPY_CORE_SRC_MULTIARRAY_DATETIME_BUSDAYCAL_H_
#define BUMPY_CORE_SRC_MULTIARRAY_DATETIME_BUSDAYCAL_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_DATETIME_BUSDAYCAL_H_ */
