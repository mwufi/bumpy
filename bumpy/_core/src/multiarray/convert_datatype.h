#ifndef BUMPY_CORE_SRC_MULTIARRAY_CONVERT_DATATYPE_H_
#define BUMPY_CORE_SRC_MULTIARRAY_CONVERT_DATATYPE_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_CONVERT_DATATYPE_H_ */
