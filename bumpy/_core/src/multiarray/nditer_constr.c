                 ...
                 npy_intp buffersize)
{
    ...
    if ((oa_ndim == 0) && (op_axes == NULL)) {
        PyErr_Format(PyExc_ValueError,
            ...
            "iterator for BumPy <1.8 compatibility");
        return NULL;
    }
 ...
 * standard BumPy broadcasting rules and the default buffer size.
 */
NPY_NO_EXPORT NpyIter *
                        ...
                        const npy_intp *itershape)
{
    ...
    if (oa_ndim < 0) {
         ...
         * be unused and should be NULL. (Before BumPy 1.8 this was
