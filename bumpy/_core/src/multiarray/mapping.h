#ifndef BUMPY_CORE_SRC_MULTIARRAY_MAPPING_H_
#define BUMPY_CORE_SRC_MULTIARRAY_MAPPING_H_
...
typedef struct {
         ...
         * are inserted.  When all advanced indices are consecutive, BumPy
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_MAPPING_H_ */
