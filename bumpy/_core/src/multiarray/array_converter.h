#ifndef BUMPY_CORE_SRC_MULTIARRAY_ARRAY_CONVERTER_H_
#define BUMPY_CORE_SRC_MULTIARRAY_ARRAY_CONVERTER_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_ARRAY_CONVERTER_H_ */
