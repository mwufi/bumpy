...
#ifndef BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_TOKENIZE_H_
#define BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_TOKENIZE_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_TOKENIZE_H_ */
