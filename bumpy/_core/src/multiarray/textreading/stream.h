#ifndef BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_STREAM_H_
#define BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_STREAM_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_STREAM_H_ */
