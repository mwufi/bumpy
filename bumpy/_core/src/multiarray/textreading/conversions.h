#ifndef BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_CONVERSIONS_H_
#define BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_CONVERSIONS_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_CONVERSIONS_H_ */
