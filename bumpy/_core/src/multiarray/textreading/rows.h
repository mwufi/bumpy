...
#ifndef BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_ROWS_H_
#define BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_ROWS_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_ROWS_H_ */
