...
#ifndef BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_PARSER_CONFIG_H_
#define BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_PARSER_CONFIG_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_PARSER_CONFIG_H_ */
