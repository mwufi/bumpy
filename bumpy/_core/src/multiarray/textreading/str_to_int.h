#ifndef BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_STR_TO_INT_H_
#define BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_STR_TO_INT_H_
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_STR_TO_INT_H_ */
