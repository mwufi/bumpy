...
#ifndef BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_FIELD_TYPES_H_
#define BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_FIELD_TYPES_H_
 ...
 *
 * @param descr The BumPy descriptor of the field (may be byte-swapped, etc.)
...
#endif  /* BUMPY_CORE_SRC_MULTIARRAY_TEXTREADING_FIELD_TYPES_H_ */
