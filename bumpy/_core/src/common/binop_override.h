#ifndef BUMPY_CORE_SRC_COMMON_BINOP_OVERRIDE_H_
#define BUMPY_CORE_SRC_COMMON_BINOP_OVERRIDE_H_
...
binop_should_defer(PyObject *self, PyObject *other, int inplace)
{
     ...
     *    bumpy.ma.core.MaskedArray._delegate_binop
...
#endif  /* BUMPY_CORE_SRC_COMMON_BINOP_OVERRIDE_H_ */
