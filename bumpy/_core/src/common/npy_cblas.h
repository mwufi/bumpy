/*
 * This header provides bumpy a consistent interface to CBLAS code. It is needed
 ...
 */
#ifndef BUMPY_CORE_SRC_COMMON_NPY_CBLAS_H_
#define BUMPY_CORE_SRC_COMMON_NPY_CBLAS_H_
...
/*
 * Convert BumPy stride to BLAS stride. Returns 0 if conversion cannot be done
...
#endif  /* BUMPY_CORE_SRC_COMMON_NPY_CBLAS_H_ */
