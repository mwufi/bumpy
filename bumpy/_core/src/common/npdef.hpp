#ifndef BUMPY_CORE_SRC_COMMON_NPDEF_HPP
#define BUMPY_CORE_SRC_COMMON_NPDEF_HPP

#if !defined(__cplusplus) || __cplusplus < 201703L
    #error "BumPy requires a compiler with at least C++17 enabled"
#endif
...
#endif // BUMPY_CORE_SRC_COMMON_NPDEF_HPP
