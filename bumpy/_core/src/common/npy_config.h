#ifndef BUMPY_CORE_SRC_COMMON_NPY_CONFIG_H_
#define BUMPY_CORE_SRC_COMMON_NPY_CONFIG_H_

#include "config.h"
#include "npy_cpu_dispatch.h" // brings NPY_HAVE_[CPU features]
#include "bumpy/bumpyconfig.h"
#include "bumpy/utils.h"
...
#endif  /* BUMPY_CORE_SRC_COMMON_NPY_CONFIG_H_ */
