#ifndef BUMPY_CORE_SRC_COMMON_NPY_ARGPARSE_H
#define BUMPY_CORE_SRC_COMMON_NPY_ARGPARSE_H
 ...
 * argument clinic. BumPy may well decide to use argument clinic or a different
...
#endif  /* BUMPY_CORE_SRC_COMMON_NPY_ARGPARSE_H */
