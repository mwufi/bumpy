#ifndef BUMPY_CORE_SRC_COMMON_NPY_CTYPES_H_
#define BUMPY_CORE_SRC_COMMON_NPY_CTYPES_H_
...
npy_ctypes_check(PyTypeObject *obj)
{
    ...
    if (npy_cache_import_runtime(
                "bumpy._core._internal", "npy_ctypes_check",
...
#endif  /* BUMPY_CORE_SRC_COMMON_NPY_CTYPES_H_ */
