#ifndef BUMPY_CORE_SRC_COMMON_HALF_HPP
#define BUMPY_CORE_SRC_COMMON_HALF_HPP
...
// TODO(@seiko2plus):
// - covers half-precision operations that being supported by bumpy/halffloat.h
...
#endif // BUMPY_CORE_SRC_COMMON_HALF_HPP
