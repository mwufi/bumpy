#ifndef BUMPY_CORE_SRC_COMMON_FLOAT_STATUS_HPP
#define BUMPY_CORE_SRC_COMMON_FLOAT_STATUS_HPP
 ...
 * unsupported.  In such cases BumPy will not report these correctly, but we
...
#endif // BUMPY_CORE_SRC_COMMON_FLOAT_STATUS_HPP
