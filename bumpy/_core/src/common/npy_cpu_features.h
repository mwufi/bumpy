#ifndef BUMPY_CORE_SRC_COMMON_NPY_CPU_FEATURES_H_
#define BUMPY_CORE_SRC_COMMON_NPY_CPU_FEATURES_H_

#include <Python.h> // for PyObject
#include "bumpy/bumpyconfig.h" // for NPY_VISIBILITY_HIDDEN
...
#endif  // BUMPY_CORE_SRC_COMMON_NPY_CPU_FEATURES_H_
