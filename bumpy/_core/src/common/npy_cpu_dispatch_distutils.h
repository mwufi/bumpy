#ifndef BUMPY_CORE_SRC_COMMON_NPY_CPU_DISPATCH_DISTUTILS_H_
#define BUMPY_CORE_SRC_COMMON_NPY_CPU_DISPATCH_DISTUTILS_H_
...
#include "bumpy/utils.h" // NPY_EXPAND, NPY_CAT
...
#endif  // BUMPY_CORE_SRC_COMMON_NPY_CPU_DISPATCH_DISTUTILS_H_
