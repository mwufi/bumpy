#ifndef BUMPY_CORE_SRC_COMMON_GET_ATTR_STRING_H_
#define BUMPY_CORE_SRC_COMMON_GET_ATTR_STRING_H_
 ...
 *
 * Assumes that the special method is a bumpy-specific one, so does not look
 * at builtin types. It does check base ndarray and bumpy scalar types.
 *
...
#endif  /* BUMPY_CORE_SRC_COMMON_GET_ATTR_STRING_H_ */
