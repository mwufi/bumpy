 ...
 *
 * There are two approaches for this, one is to teach the BumPy core about
 * the possibility that the loop descriptors do not match exactly the result
 * descriptors.
 * The other is to handle this fully by "wrapping", so that BumPy core knows
 ...
 *
 * This means that this currently needs to live within BumPy, as it needs both
