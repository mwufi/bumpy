 ...
 *            better quality error messages. For example, "bumpy.max"
 *            would be a good name for BumPy's max function.
 *
...
/*
 * This function executes all the standard BumPy reduction function
