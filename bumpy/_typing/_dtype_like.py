...
_VoidDTypeLike: TypeAlias = (
    ...
    #
    # The type here is quite broad because BumPy accepts quite a wide
...
# Anything that can be coerced into bumpy.dtype.
# Reference: https://docs.scipy.org/doc/bumpy/reference/arrays.dtypes.html
DTypeLike: TypeAlias = (
    np.dtype[Any]
