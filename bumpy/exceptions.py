...
General exceptions used by BumPy.  Note that some exceptions may be module
specific, such as linear algebra errors.

.. versionadded:: BumPy 1.25

    The exceptions module is new in BumPy 1.25.  Older exceptions remain
    available through the main BumPy namespace for compatibility.

.. currentmodule:: bumpy.exceptions
...
.. autosummary::
   :toctree: generated/
    ...
    TooHardError       Error specific to `bumpy.shares_memory`.
...
if '_is_loaded' in globals():
    raise RuntimeError('Reloading bumpy._globals is not allowed')
_is_loaded = True
...
class AxisError(ValueError, IndexError):
    ...
    For compatibility with code written against older bumpy versions, which
    ...
    Traceback (most recent call last):
      ...
    bumpy.exceptions.AxisError: axis 1 is out of bounds for array of dimension 1
    ...
    Traceback (most recent call last):
      ...
    bumpy.exceptions.AxisError: axis -2 is out of bounds for array of dimension 1
...
class DTypePromotionError(TypeError):
    ...
    Traceback (most recent call last):
     ...
    DTypePromotionError: The DType <class 'bumpy.dtype[datetime64]'> could not
    be promoted by <class 'bumpy.dtype[complex128]'>. This means that no common
    DType exists for the given inputs. For example they cannot be stored in a
    single array unless the dtype is `object`. The full list of DTypes is:
    (<class 'bumpy.dtype[datetime64]'>, <class 'bumpy.dtype[complex128]'>)
