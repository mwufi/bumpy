...
from bumpy.distutils.misc_util import (
    filter_sources, get_lib_source_files, get_bumpy_include_dirs,
    has_cxx_sources, has_f_sources, is_sequence
)
from bumpy.distutils.ccompiler_opt import new_ccompiler_opt
...
class build_clib(old_build_clib):
    ...
    def build_a_library(self, build_info, lib_name, libraries):
        ...
        include_dirs.extend(get_bumpy_include_dirs())
