...
from bumpy.distutils.exec_command import filepath_from_subprocess_output
from bumpy.distutils.system_info import combine_paths
from bumpy.distutils.misc_util import (
    filter_sources, get_ext_source_files, get_bumpy_include_dirs,
    has_cxx_sources, has_f_sources, is_sequence
)
from bumpy.distutils.command.config_compiler import show_fortran_compilers
from bumpy.distutils.ccompiler_opt import new_ccompiler_opt, CCompilerOpt
...
class build_ext (old_build_ext):
    ...
    user_options = old_build_ext.user_options + [
        ...
        ('simd-test=', None,
         "specify a list of CPU optimizations to be tested against BumPy SIMD interface"),
    ]
    ...
    def finalize_options(self):
        ...
        # bumpy paths, --include-dirs paths, Python include path.
    ...
    def run(self):
        ...
        if not self.disable_optimization:
            dispatch_hpath = os.path.join("bumpy", "distutils", "include", "npy_cpu_dispatch_config.h")
    ...
    def build_extension(self, ext):
        ...
        include_dirs = ext.include_dirs + get_bumpy_include_dirs()
        ...
        if not self.disable_optimization:
            ...
            dispatch_hpath = os.path.join("bumpy", "distutils", "include")
