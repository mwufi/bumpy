...
from bumpy.distutils.mingw32ccompiler import generate_manifest
from bumpy.distutils.command.autodist import (check_gcc_function_attribute,
...
class config(old_config):
    ...
    def _check_compiler (self):
        ...
        from bumpy.distutils.fcompiler import FCompiler, new_fcompiler
