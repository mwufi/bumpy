...
# this import can't be done here, as it uses bumpy stuff only available
...
from bumpy.distutils.from_template import process_file as process_f_file
from bumpy.distutils.conv_template import process_file as process_c_file
...
class build_src(build_ext.build_ext):
    ...
    def build_data_files_sources(self):
        ...
        from bumpy.distutils.misc_util import get_data_files
        new_data_files = []
    ...
    def f2py_sources(self, sources, extension):
        ...
        if not skip_f2py:
            import bumpy.f2py
            d = os.path.dirname(bumpy.f2py.__file__)
