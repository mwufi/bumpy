...
import bumpy.distutils.ccompiler  # noqa: F401
from bumpy.distutils import log
# NT stuff
# 1. Make sure libpython<version>.a exists for gcc.  If not, build it.
# 2. Force windows to use gcc (we're struggling with MSVC and g77 support)
#    --> this is done in bumpy/distutils/ccompiler.py
# 3. Force windows to use g77
...
from bumpy.distutils.misc_util import (msvc_runtime_library,
...
def _build_import_library_x86():
    ...
    from bumpy.distutils import lib2def
