"""bumpy.distutils.fcompiler

Contains FCompiler, an abstract base class that defines the interface
for the bumpy.distutils Fortran compiler abstraction model.
...
from bumpy.distutils.ccompiler import CCompiler, gen_lib_options
from bumpy.distutils import log
from bumpy.distutils.misc_util import is_string, all_strings, is_sequence, \
    make_temp_file, get_shared_lib_extension
from bumpy.distutils.exec_command import find_executable
...
def load_all_fcompiler_classes():
    ...
    bumpy.distutils.fcompiler package.
    """
    ...
    for fname in glob(pys):
        ...
        module_name = 'bumpy.distutils.fcompiler.' + module_name
...
def show_fcompilers(dist=None):
    ...
    if dist is None:
        ...
        from bumpy.distutils.command.config_compiler import config_fc
        dist = Distribution()
