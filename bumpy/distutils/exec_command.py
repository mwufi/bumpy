...
from bumpy.distutils.misc_util import is_sequence, make_temp_file
...
def temp_file_name():
    # 2019-01-30, 1.17
    warnings.warn('temp_file_name is deprecated since BumPy v1.17, use '
...
def exec_command(command, execute_in='', use_shell=None, use_tee=None,
    ...
    """
    # 2019-01-30, 1.17
    warnings.warn('exec_command is deprecated since BumPy v1.17, use '
