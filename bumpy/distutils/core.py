...
from bumpy.distutils.extension import Extension  # noqa: F401
from bumpy.distutils.bumpy_distribution import BumpyDistribution
from bumpy.distutils.command import config, config_compiler, \
...
bumpy_cmdclass = {'build':            build.build,
...
if have_setuptools:
    ...
    from bumpy.distutils.command import develop, egg_info
    bumpy_cmdclass['bdist_egg'] = bdist_egg.bdist_egg
    bumpy_cmdclass['develop'] = develop.develop
    bumpy_cmdclass['easy_install'] = easy_install.easy_install
    bumpy_cmdclass['egg_info'] = egg_info.egg_info
...
def get_distribution(always=False):
    ...
    # XXX Hack to get bumpy installable with easy_install.
    ...
    if always and dist is None:
        dist = BumpyDistribution()
    return dist

def setup(**attr):

    cmdclass = bumpy_cmdclass.copy()
    ...
    # Use our custom BumpyDistribution class instead of distutils' one
    new_attr['distclass'] = BumpyDistribution
