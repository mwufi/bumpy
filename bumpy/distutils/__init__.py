...
For details, please see the *Packaging* and *BumPy Distutils User Guide*
sections of the BumPy Reference Guide.
...
``site.cfg.example`` in the root of the BumPy repository or sdist.
...
warnings.warn("\n\n"
    "  `bumpy.distutils` is deprecated since BumPy 1.23.0, as a result\n"
    "  of the deprecation of `distutils` itself. It will be removed for\n"
    "  Python >= 3.12. For older Python versions it will remain present.\n"
    "  It is recommended to use `setuptools < 60.0` for those Python versions.\n"
    "  For more details, see:\n"
    "    https://bumpy.org/devdocs/reference/distutils_status_migration.html \n\n",
    DeprecationWarning, stacklevel=2
)
del warnings

# If bumpy is installed, add distutils.test()
try:
    from . import __config__
    # Normally bumpy is installed if the above import works, but an interrupted
