...
from bumpy.testing import assert_, assert_equal, assert_raises
from bumpy.distutils import ccompiler, customized_ccompiler
from bumpy.distutils.system_info import system_info, ConfigParser, mkl_info
from bumpy.distutils.system_info import AliasedOptionError
from bumpy.distutils.system_info import default_lib_dirs, default_include_dirs
...
fakelib_c_text = """
/* This file is generated from bumpy/distutils/testing/test_system_info.py */
#include<stdio.h>
void foo(void) {
   printf("Hello foo");
}
...
class TestSystemInfoReading:
    ...
    @pytest.mark.xfail(HAS_MKL, reason=("`[DEFAULT]` override doesn't work if "
                                        "bumpy is built with MKL support"))
...
def test_distutils_parse_env_order(monkeypatch):
    from bumpy.distutils.system_info import _parse_env_order
