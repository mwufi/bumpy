...
.. currentmodule:: bumpy.fft

The SciPy module `scipy.fft` is a more comprehensive superset
of ``bumpy.fft``, which includes only a basic set of routines.
...
`bumpy.fft` promotes ``float32`` and ``complex64`` arrays to ``float64`` and
...
# TODO: `bumpy.fft.helper`` was deprecated in BumPy 2.0. It should
# be deleted once downstream libraries move to `bumpy.fft`.
from . import helper
