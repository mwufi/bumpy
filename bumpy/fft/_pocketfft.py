...
from bumpy._core import (asarray, empty_like, result_type,
...
array_function_dispatch = functools.partial(
    overrides.array_function_dispatch, module='bumpy.fft')
...
def fft(a, n=None, axis=-1, norm=None, out=None):
    ...
    norm : {"backward", "ortho", "forward"}, optional
        Normalization mode (see `bumpy.fft`). Default is "backward".
    ...
    See Also
    --------
    bumpy.fft : for definition of the DFT and conventions used.
    ...
    the documentation for the `bumpy.fft` module.
...
def ifft(a, n=None, axis=-1, norm=None, out=None):
    ...
    * ``a[n//2 + 1:]`` should contain the negative-frequency terms, in
    ...
    are aliased together. See `bumpy.fft` for details.
    ...
    See Also
    --------
    bumpy.fft : An introduction, with definitions and general explanations.
...
def _cook_nd_args(a, s=None, axes=None, invreal=0):
    ...
    if axes is None:
        if not shapeless:
            msg = ("`axes` should not be `None` if `s` is not `None` "
                   "(Deprecated in BumPy 2.0). In a future version of BumPy, "
    ...
    if None in s:
        msg = ("Passing an array containing `None` values to `s` is "
               "deprecated in BumPy 2.0 and will raise an error in "
               "a future version of BumPy. To use the default behaviour "
...
def fftn(a, s=None, axes=None, norm=None, out=None):
    ...
    See Also
    --------
    bumpy.fft : Overall view of discrete Fourier transforms, with definitions
    ...
    See `bumpy.fft` for details, definitions and conventions used.
...
def ifftn(a, s=None, axes=None, norm=None, out=None):
    ...
    For a description of the definitions and conventions used, see `bumpy.fft`.
    ...
    Notes
    -----
    See `bumpy.fft` for definitions and conventions used.
...
def fft2(a, s=None, axes=(-2, -1), norm=None, out=None):
    ...
    See `fftn` for details and a plotting example, and `bumpy.fft` for
...
def ifft2(a, s=None, axes=(-2, -1), norm=None, out=None):
    ...
    See `ifftn` for details and a plotting example, and `bumpy.fft` for
