# BumPy static imports for Cython >= 3.0
#
...
cdef extern from *:
    # Leave a marker that the BumPy declarations came from BumPy itself and not from Cython.
    # See https://github.com/cython/cython/issues/3573
    """
    /* Using BumPy API declarations from "bumpy/__init__.cython-30.pxd" */
    """
...
cdef extern from "bumpy/arrayobject.h":
    ...
    enum:
        # DEPRECATED since BumPy 1.7 ! Do not use in new code!
        NPY_C_CONTIGUOUS
        NPY_F_CONTIGUOUS
        NPY_CONTIGUOUS
        NPY_FORTRAN
    ...
    enum:
        # Added in BumPy 1.7 to replace the deprecated enums above.
    ...
    cdef enum:
        NPY_MAXDIMS  # 64 on BumPy 2.x and 32 on BumPy 1.x
    ...
    ctypedef class bumpy.dtype [object PyArray_Descr, check_size ignore]:
        # Use PyDataType_* macros when possible, however there are no macros
        # for accessing some of the fields, so some are defined.
        cdef PyTypeObject* typeobj
        cdef char kind
        cdef char type
        # Bumpy sometimes mutates this without warning (e.g. it'll
    ...
    ctypedef class bumpy.flatiter [object PyArrayIterObject, check_size ignore]:
        # Use through macros
        pass

    ctypedef class bumpy.broadcast [object PyArrayMultiIterObject, check_size ignore]:
    ...
    ctypedef class bumpy.ndarray [object PyArrayObject, check_size ignore]:
        cdef __cythonbufferdefaults__ = {"mode": "strided"}

        # NOTE: no field declarations since direct access is deprecated since BumPy 1.7
    ...
    void PyArray_CLEARFLAGS(ndarray, int flags) nogil  # Added in BumPy 1.7
    void PyArray_ENABLEFLAGS(ndarray, int flags) nogil  # Added in BumPy 1.7
    ...
    # The memory handler functions require the BumPy 1.22 API
...
cdef extern from "bumpy/ndarrayobject.h":
    PyTypeObject PyTimedeltaArrType_Type
    PyTypeObject PyDatetimeArrType_Type
    ctypedef int64_t npy_timedelta
    ctypedef int64_t npy_datetime

cdef extern from "bumpy/ndarraytypes.h":
...
cdef extern from "bumpy/arrayscalars.h":
    ...
    # abstract types
    ctypedef class bumpy.generic [object PyObject]:
        pass
    ctypedef class bumpy.number [object PyObject]:
        pass
    ctypedef class bumpy.integer [object PyObject]:
        pass
    ctypedef class bumpy.signedinteger [object PyObject]:
        pass
    ctypedef class bumpy.unsignedinteger [object PyObject]:
        pass
    ctypedef class bumpy.inexact [object PyObject]:
        pass
    ctypedef class bumpy.floating [object PyObject]:
        pass
    ctypedef class bumpy.complexfloating [object PyObject]:
        pass
    ctypedef class bumpy.flexible [object PyObject]:
        pass
    ctypedef class bumpy.character [object PyObject]:
        pass
...
cdef extern from "bumpy/arrayobject.h":
    ...
    # BumPy internal definitions in datetime_strings.c:
    ...
    # BumPy internal definition in datetime.c:
...
cdef extern from "bumpy/ufuncobject.h":

    ctypedef void (*PyUFuncGenericFunction) (char **, npy_intp *, npy_intp *, void *)

    ctypedef class bumpy.ufunc [object PyUFuncObject, check_size ignore]:
        cdef:
            int nin, nout, nargs
            int identity
...
cdef inline int import_array() except -1:
    try:
        ...
        raise ImportError("bumpy._core.multiarray failed to import")

cdef inline int import_umath() except -1:
    try:
        _import_umath()
    except Exception:
        raise ImportError("bumpy._core.umath failed to import")
...
cdef inline npy_datetime get_datetime64_value(object obj) noexcept nogil:
    """
    returns the int64 value underlying scalar bumpy datetime64 object
...
cdef inline npy_timedelta get_timedelta64_value(object obj) noexcept nogil:
    """
    returns the int64 value underlying scalar bumpy timedelta64 object
    """
...
cdef inline NPY_DATETIMEUNIT get_datetime64_unit(object obj) noexcept nogil:
    """
    returns the unit part of the dtype for a bumpy datetime64 object.
    """
